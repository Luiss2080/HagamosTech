import RecorridoPortales from '../components/RecorridoPortales';
...
const CLIENTES = ['Rintisa', 'Arca Continental', 'Urbano', 'Tai Loy', 'Levapan', 'BSF Almacenes', 'Grupo EFE'];
...
const PROCESO = [
  { title: 'Definición de Catálogo', desc: 'Estructuramos las categorías de productos, atributos, variantes (tallas, colores) y flujos de inventario.' },
  { title: 'Flujo de Compra', desc: 'Diseñamos un carrito de compras interactivo y un checkout rápido en un solo paso para evitar deserciones.' },
  { title: 'Pasarela & QR', desc: 'Integramos métodos de pago locales como tarjetas de crédito, débito y cobro inmediato por códigos QR bancarios.' },
  { title: 'Testing & Seguridad', desc: 'Validamos flujos de transacciones, envío de confirmaciones por correo e implementamos encriptación de datos.' }
];
...
const VALUE_POINTS = [
  { icon: 'fa-shopping-cart', label: 'E-commerce a Medida' },
  { icon: 'fa-qrcode', label: 'Pagos QR dinámicos' },
  { icon: 'fa-warehouse', label: 'Control de Inventarios' },
  { icon: 'fa-shield', label: 'Pasarelas de Pago Seguras' }
];
    ...
    <div className="relative overflow-hidden min-h-screen bg-white dark:bg-[#0a0a0a] font-montserrat">
      ...
      <section className="relative overflow-hidden pt-20 pb-12" id="home">
        <div className="container mx-auto px-6 max-w-7xl relative z-10 flex flex-col items-center">
          ...
          <Breadcrumb
            paths={[{ label: 'Soluciones' }, { label: 'Portales Institucionales' }]}
            badgeText="Portales Institucionales — TECH HOME"
          ...
          <div className="flex flex-col xl:flex-row items-center xl:items-stretch gap-4 xl:-gap-8 justify-between w-full">
            ...
            <div className="w-full xl:w-[35%] flex flex-col gap-5 text-center items-center xl:justify-center animate-slide-down">
              ...
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-[#a41e22] to-[#7f1d1d] text-white border border-[#c5a059]/40 shadow-md">
                ...
                <span className="text-[9px] font-black uppercase tracking-wider">Cuota por estudiante (mensual) + Configuración inicial</span>
              </div>
            </div>
            ...
            <div className="w-full xl:w-[52%] relative min-h-[280px] sm:min-h-[360px] md:min-h-[400px] lg:min-h-[440px] xl:min-h-[480px] flex items-center justify-center -mb-4 sm:mb-0">
              ...
              <div className="relative z-10 w-full max-w-[420px] sm:max-w-[540px] md:max-w-[620px] lg:max-w-[680px] xl:max-w-[740px] 2xl:max-w-[820px] ml-auto animate-fade-in-up delay-200 group/hero flex items-center justify-center mt-6 sm:mt-8">
                ...
                >
                  <img
                    src="/img/07_Servicios/soluciones/PortalesInstitucionales.png"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-6 text-center flex flex-col items-center justify-center">
              ...
              <div className="space-y-6 text-[#5c6f8f] dark:text-slate-355 font-bold leading-relaxed text-sm sm:text-base max-w-2xl text-justify">
                <p>
                  Plataformas integrales para instituciones educativas, públicas y privadas, que reúnen a estudiantes, docentes y administración en un solo lugar, simplificando cada proceso académico.
                </p>
                <p>
                  <span className="font-black uppercase tracking-widest text-[#a41e22] dark:text-red-400">Incluye: </span>
                  Portal del Estudiante, Portal del Docente, Panel Administrativo, Calificaciones, Inscripciones, Pagos, Comunicados, Biblioteca Virtual, Aulas Virtuales y Gestión Documental.
                </p>
              </div>
            </div>
              ...
              <div className="bg-[#1e1e1e] rounded-3xl shadow-2xl border border-neutral-800 overflow-hidden text-left relative group">
                ...
                <div className="bg-[#252526] p-3 flex items-center justify-between border-b border-neutral-900">
                  <div className="flex items-center gap-1.5">
                    ...
                    <span className="text-[10px] text-slate-400 font-bold ml-2 font-mono">checkout.js</span>
                  </div>
                ...
                <div className="p-5 font-mono text-[10.5px] sm:text-[11.5px] leading-relaxed text-slate-300 overflow-x-auto select-none space-y-1">
                  <div>import &#123; PaymentGateway &#125; from "./payments";</div>
                  <div className="mt-2">export const ECommerceCheckout = (&#123; cart &#125;) =&gt; &#123;</div>
                  <div className="pl-4">const handlePayment = async () =&gt; &#123;</div>
                  <div className="pl-8">const qr = await PaymentGateway.generateQR(cart.total);</div>
                  <div className="pl-8">showQRModal(qr);</div>
                  <div className="pl-4">&#125;;</div>
                  <div className="pl-4">return &lt;button onClick=&#123;handlePayment&#125;&gt;Pagar con QR&lt;/button&gt;;</div>
                  <div>&#125;;</div>
                </div>
        ...
        <div className="w-full max-w-[1200px] xl:max-w-[1400px] mx-auto px-4 relative z-10 flex flex-col items-center">
          ...
          <div className="text-center mb-6 max-w-4xl mx-auto">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-[#111827] dark:text-white leading-[1.1] mb-6">
              ¿Cómo vendes hoy <br className="hidden md:block" />
            ...
            <p className="text-base sm:text-lg text-gray-500 dark:text-slate-400 font-medium leading-relaxed max-w-2xl mx-auto mb-6">
              Compara tus procesos de ventas físicas o telefónicas manuales frente a una Portal Institucional automatizada 24/7.
            </p>
            ...
            <div className="flex justify-center">
              <div className="inline-flex p-2 bg-white dark:bg-[#0a0a0a] rounded-full shadow-[0_8px_30px_rgba(0,0,0,0.08)] border border-gray-100 dark:border-[#a41e22]/20 relative z-50 ring-4 ring-gray-50 dark:ring-black/10 scale-[0.85] sm:scale-90 md:scale-100 origin-center mx-auto">
                ...
                >
                  <i className="fa-solid fa-triangle-exclamation"></i> Sin E-commerce
                </button>
                <button
                ...
                >
                  <i className="fa-solid fa-circle-check"></i> Con E-commerce
                </button>
              </div>
            </div>
          </div>
              ...
              <div className={`bg-white dark:bg-[#0a0a0a] rounded-[2.25rem] sm:rounded-[2.5rem] w-full h-full md:min-h-[560px] lg:min-h-[600px] relative overflow-hidden flex flex-col border border-red-50 dark:border-[#a41e22]/10 shadow-[0_20px_60px_-15px_rgba(239,68,68,0.15)] transition-all duration-500 pb-3 sm:pb-4 md:pb-5
                ...
                <div className="bg-red-50/50 dark:bg-black/30 px-3 py-4 sm:px-4 sm:py-5 md:px-5 md:py-6 border-b border-red-50 dark:border-[#a41e22]/10 relative overflow-hidden">
                  <div className="relative z-10 flex flex-col gap-3">
                    ...
                    <p className="text-center text-[11px] sm:text-sm text-red-500/80 font-semibold max-w-xl mx-auto">
                      Depósitos validados manualmente, llamadas y pérdida constante de clientes.
                    </p>
                  </div>
                </div>
                ...
                <div className="p-2 sm:p-3 md:p-4 relative flex-1 flex flex-col rounded-[2rem] sm:rounded-[2.25rem] overflow-hidden">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 relative z-10 w-full h-full content-start">
                    {[
                      { title: "Llamadas de Pedidos", icon: "fa-phone", desc: "Saturación de líneas de atención" },
                      { title: "Verificación de Depósitos", icon: "fa-clock", desc: "Espera de confirmación de saldo" },
                      { title: "Quiebres de Inventario", icon: "fa-warehouse", desc: "Vender productos sin stock real" },
                      { title: "Carrito Inseguro", icon: "fa-shield-halved", desc: "Formularios de pago vulnerables" },
                      { title: "Despacho Manual", icon: "fa-truck", desc: "Preparación lenta del pedido" },
                      { title: "Pérdida de Clientes", icon: "fa-arrow-down", desc: "Abandono por flujos lentos" }
                    ].map((item, i) => (
                      <div
                        key={i}
            ...
            >
              <div className={`bg-gradient-to-br from-[#a41e22] to-[#7f1d1d] w-full h-full md:min-h-[560px] lg:min-h-[600px] relative overflow-hidden flex flex-col rounded-[2.25rem] sm:rounded-[2.5rem] shadow-2xl border border-white/20 transition-all duration-500 pb-3 sm:pb-4 md:pb-5
                  ...
                  <div className="relative z-10 flex flex-col gap-3">
                    ...
                    <div className="flex items-center justify-center gap-3">
                      <h3 className="text-xl sm:text-2xl font-black text-white leading-none">
                        E-commerce Tech Home
                      </h3>
                    </div>
                    <p className="text-center text-[11px] sm:text-sm text-blue-50/90 font-semibold max-w-xl mx-auto">
                      Checkout en un solo paso, cobros QR automáticos e inventario sincronizado.
                    </p>
                  </div>
                </div>
                ...
                <div className="p-2 sm:p-3 md:p-4 relative flex-1 flex flex-col rounded-[2rem] sm:rounded-[2.25rem] overflow-hidden">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 relative z-10 w-full h-full content-start">
                    {[
                      { title: "Venta 24/7 Digital", icon: "fa-cart-shopping", desc: "Pedidos automáticos sin asesores" },
                      { title: "Pasarela QR Integrada", icon: "fa-qrcode", desc: "Conciliación bancaria en tiempo real" },
                      { title: "Control de Stock", icon: "fa-warehouse", desc: "Stock actualizado al instante" },
                      { title: "Pagos Blindados", icon: "fa-lock", desc: "Encriptación SSL en pasarelas" },
                      { title: "Notificaciones Automáticas", icon: "fa-envelope", desc: "Correos con tracking del despacho" },
                      { title: "Escalabilidad Total", icon: "fa-arrow-trend-up", desc: "Soporta miles de visitas concurrentes" }
                    ].map((item, i) => (
                      <div
                        key={i}
