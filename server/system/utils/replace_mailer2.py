...
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#FFF5EC;background-image:linear-gradient(180deg, #FFF5EC 0%, #FFE3D5 100%);">
<tr>
<td align="center">

<!-- ── HEADER (Estilo Web) ── -->
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#FFF5EC;border-bottom:1px solid rgba(255,77,0,0.15);box-shadow:0 10px 15px -3px rgba(255,77,0,0.05);margin-bottom:30px;">
  <tr>
    <td align="center" style="padding:15px 0;">
      <img src="cid:logoHeader" alt="${BRAND}" width="260" style="display:block; max-width:100%; height:auto;">
    </td>
  </tr>
</table>

<!-- ── TARJETA PRINCIPAL (Estilo Hero) ── -->
<table role="presentation" width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#ffffff;border-radius:32px;box-shadow:0 20px 50px rgba(139,69,19,0.08);overflow:hidden;margin-bottom:20px;">
...
<td style="background-color:#8B3A13;background-image:linear-gradient(180deg, #8B3A13 0%, #5C2307 100%);border-top:5px solid #FF4D00;padding:35px 40px;text-align:center;">
  <img src="cid:logoFooter" alt="${BRAND}" width="160" style="display:block; margin:0 auto 15px; max-width:100%; height:auto; opacity:0.95;">
