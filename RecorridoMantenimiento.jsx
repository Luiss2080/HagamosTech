...
const PROJECTS = [
  {
    num: '01',
    category: 'REFACTOR',
    firstPart: 'Refactorización',
    highlightPart: 'App Legacy',
    desc: 'Modernización de sistemas antiguos escritos en tecnologías obsoletas hacia stacks modernos, mejorando la seguridad, velocidad y mantenibilidad.',
    tags: ['React', 'Node.js', 'AWS', 'Git'],
    icon: 'fa-code-branch',
    images: [
  ...
  },
  {
    ...
    category: 'CLOUD',
    firstPart: 'Migración',
    highlightPart: 'a Servidores Cloud',
    desc: 'Traslado de infraestructura on-premise a la nube (AWS/Google Cloud) garantizando alta disponibilidad y escalabilidad automática.',
    tags: ['AWS', 'Docker', 'Git', 'MySQL'],
  ...
  },
  {
    num: '03',
    category: 'SECURITY',
    firstPart: 'Auditoría y',
    highlightPart: 'Parches',
    desc: 'Análisis exhaustivo de vulnerabilidades en el código, bases de datos y servidores, aplicando parches de seguridad críticos para cumplir normativas.',
    tags: ['Python', 'Docker', 'AWS', 'MySQL'],
  ...
  },
  {
    num: '04',
    category: 'UX/UI',
    firstPart: 'Modernización',
    highlightPart: 'Visual',
    desc: 'Rediseño completo de la interfaz de usuario de plataformas existentes, adaptando la experiencia a los estándares y dispositivos actuales.',
    tags: ['Figma', 'Tailwind CSS', 'React', 'Next.js'],
...
export default RecorridoMantenimiento;
