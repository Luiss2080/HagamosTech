...
const PROJECTS = [
  {
    ...
    category: 'EDU',
    firstPart: 'Portal de',
    highlightPart: 'Colegio',
    desc: 'Plataforma integral para colegios con aula virtual, agenda escolar, control de notas y comunicación directa entre docentes y padres.',
  ...
  },
  {
    num: '02',
    category: 'UNIV',
    firstPart: 'Plataforma',
    highlightPart: 'Universitaria',
    desc: 'Sistema de gestión académica superior con inscripción de materias, kardex digital, biblioteca virtual y pagos en línea.',
    tags: ['Laravel', 'MySQL', 'Docker', 'Git'],
  ...
  },
  {
    num: '03',
    category: 'ONG',
    firstPart: 'Sistema para',
    highlightPart: 'ONG/Fundación',
    desc: 'Portal institucional enfocado en la transparencia, gestión de donaciones recurrentes, voluntariado y publicación de memorias anuales.',
    tags: ['Next.js', 'Tailwind CSS', 'Stripe', 'AWS'],
  ...
  },
  {
    ...
    category: 'ACADEMY',
    firstPart: 'Academia',
    highlightPart: 'Online',
    desc: 'Plataforma LMS para venta de cursos grabados, exámenes automatizados, foros de discusión y emisión de certificados digitales.',
    tags: ['React', 'Vue.js', 'MySQL', 'AWS'],
...
export default RecorridoPortales;
