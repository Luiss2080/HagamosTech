                ...
                >
                  <div className="bg-white dark:bg-gradient-to-br dark:from-[#111] dark:to-[#080808] dark:border dark:border-[#a41e22]/10 p-6 sm:p-7 rounded-[2rem] shadow-[0_10px_35px_rgba(0,0,0,0.04)] border border-slate-100/80 flex flex-col justify-between h-full min-h-[300px] hover:shadow-[0_20px_50px_rgba(164,30,34,0.12)] hover:-translate-y-1.5 hover:border-[#c5a059]/30 dark:hover:border-[#c5a059]/30 transition-all duration-500 relative group">
                    ...
                    <div className="flex justify-between items-center mb-4">
                      ...
                      <div className="w-8 h-8 rounded-full bg-[#a41e22]/5 dark:bg-[#a41e22]/10 flex items-center justify-center text-[#a41e22] dark:text-red-400 group-hover:bg-[#a41e22] group-hover:text-white transition-all duration-300">
                        <Quote size={14} className="transform rotate-185" />
                      </div>
                    </div>

                    {/* Review text */}
                    <p className="text-slate-655 dark:text-slate-355 text-xs sm:text-[13px] font-bold leading-relaxed mb-6 flex-grow text-left italic">
                      "{t.text}"
                    </p>

                    {/* Person Metadata */}
                    <div className="flex items-center gap-3.5 border-t border-slate-100 dark:border-white/5 pt-4 mt-auto">
                      <div className="w-11 h-11 rounded-full p-[2px] bg-gradient-to-tr from-[#a41e22] to-[#c5a059] shadow-md flex-shrink-0">
                        <div className="w-full h-full rounded-full overflow-hidden bg-white dark:bg-[#111]">
                          <img 
                      ...
                      <div className="text-left leading-tight">
                        <h4 className="text-[12px] font-black uppercase tracking-wider text-slate-800 dark:text-white mb-0.5">
                          {t.name}
                        </h4>
                        <p className="text-[9px] font-bold text-gray-500 dark:text-slate-400">
                          {t.role}
                        </p>
                      </div>
                    </div>
