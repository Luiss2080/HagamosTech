import RecorridoMantenimiento from '../components/RecorridoMantenimiento';
...
const CLIENTES = ['La Calera', 'Hierro Shougang', 'Arca Continental', 'Urbano', 'BSF Almacenes', 'Naltech', 'Nexa'];
...
const PROCESO = [
  { title: 'Reunión de Diagnóstico', desc: 'Identificamos incidentes frecuentes, arquitectura de servidores y áreas críticas de mantenimiento.' },
  { title: 'Definición de SLA', desc: 'Establecemos acuerdos de nivel de servicio (SLA) con tiempos de respuesta garantizados por contrato.' },
  { title: 'Actualizaciones de Parches', desc: 'Ejecutamos periódicamente copias de seguridad, actualizaciones de frameworks y parches de seguridad.' },
  { title: 'Mesa de Ayuda 24/7', desc: 'Habilitamos el canal prioritario de comunicación directa con ingenieros para reportar incidentes.' }
];
...
const VALUE_POINTS = [
  { icon: 'fa-screwdriver-wrench', label: 'Soporte TI 24/7' },
  { icon: 'fa-file-signature', label: 'SLA Garantizado por Contrato' },
  { icon: 'fa-headset', label: 'Mesa de Ayuda Dedicada' },
  { icon: 'fa-rotate', label: 'Actualizaciones de Seguridad' }
];

const SoporteActualizacion = () => {
    ...
    <div className="relative overflow-hidden min-h-screen bg-white dark:bg-[#0a0a0a] font-montserrat">
      ...
      <section className="relative overflow-hidden pt-20 pb-12" id="home">
        <div className="container mx-auto px-6 max-w-7xl relative z-10 flex flex-col items-center">
          ...
          <Breadcrumb
            paths={[{ label: 'Soluciones' }, { label: 'Mantenimiento y Actualización' }]}
            badgeText="Mantenimiento de Sistemas — TECH HOME"
            icon="fa-headset"
            align="center"
          />
          ...
          <div className="flex flex-col xl:flex-row items-center xl:items-stretch gap-4 xl:-gap-8 justify-between w-full">
            ...
            <div className="w-full xl:w-[35%] flex flex-col gap-5 text-center items-center xl:justify-center animate-slide-down">
              ...
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-[#a41e22] to-[#7f1d1d] text-white border border-[#c5a059]/40 shadow-md">
                ...
                <span className="text-[9px] font-black uppercase tracking-wider">Mantenimiento mensual o Bolsa de horas</span>
              </div>
            </div>
            ...
            <div className="w-full xl:w-[52%] relative min-h-[280px] sm:min-h-[360px] md:min-h-[400px] lg:min-h-[440px] xl:min-h-[480px] flex items-center justify-center -mb-4 sm:mb-0">
              ...
              <div className="relative z-10 w-full max-w-[420px] sm:max-w-[540px] md:max-w-[620px] lg:max-w-[680px] xl:max-w-[740px] 2xl:max-w-[820px] ml-auto animate-fade-in-up delay-200 group/hero flex items-center justify-center mt-6 sm:mt-8">
                ...
                >
                  <img
                    src="/img/07_Servicios/soluciones/MantenimientoActualizacion.png"
                    alt="Soporte & Consultoría"
                    loading="eager"
                    fetchPriority="high"
                    decoding="async"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-6 text-center flex flex-col items-center justify-center">
              ...
              <div className="space-y-6 text-[#5c6f8f] dark:text-slate-355 font-bold leading-relaxed text-sm sm:text-base max-w-2xl text-justify">
                <p>
                  Garantizamos que los sistemas críticos de tu empresa funcionen sin caídas imprevistas, con actualización constante, optimización de rendimiento y nuevas funcionalidades.
                </p>
                <p>
                  <span className="font-black uppercase tracking-widest text-[#a41e22] dark:text-red-400">Incluye: </span>
                  Actualización, Modernización de interfaces, Corrección de errores, Optimización, Nuevas funcionalidades, Compatibilidad, Migración, Bases de Datos, Refactorización, Auditoría y Documentación.
                </p>
              </div>
            </div>
              ...
              <div className="bg-[#1e1e1e] rounded-3xl shadow-2xl border border-neutral-800 overflow-hidden text-left relative group">
                ...
                <div className="bg-[#252526] p-3 flex items-center justify-between border-b border-neutral-900">
                  <div className="flex items-center gap-1.5">
                    ...
                    <span className="text-[10px] text-slate-400 font-bold ml-2 font-mono">sla_config.json</span>
                  </div>
                ...
                <div className="p-5 font-mono text-[10.5px] sm:text-[11.5px] leading-relaxed text-slate-300 overflow-x-auto select-none space-y-1">
                  <div>&#123;</div>
                  <div className="pl-4">"sla_configuration": &#123;</div>
                  <div className="pl-8">"critical_incident_response_hours": 2,</div>
                  <div className="pl-8">"major_incident_response_hours": 4,</div>
                  <div className="pl-8">"minor_incident_response_hours": 8,</div>
                  <div className="pl-8">"uptime_commitment_percentage": 99.9</div>
        ...
        <div className="w-full max-w-[1200px] xl:max-w-[1400px] mx-auto px-4 relative z-10 flex flex-col items-center">
          ...
          <div className="text-center mb-6 max-w-4xl mx-auto">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-[#111827] dark:text-white leading-[1.1] mb-6">
              ¿Cómo mantienes tus servidores hoy <br className="hidden md:block" />
            ...
            <p className="text-base sm:text-lg text-gray-500 dark:text-slate-400 font-medium leading-relaxed max-w-2xl mx-auto mb-6">
              Compara la corrección reactiva tardía de incidentes frente al mantenimiento preventivo y soporte con SLA garantizado de TECH HOME.
            </p>
            ...
            <div className="flex justify-center">
              <div className="inline-flex p-2 bg-white dark:bg-[#0a0a0a] rounded-full shadow-[0_8px_30px_rgba(0,0,0,0.08)] border border-gray-100 dark:border-[#a41e22]/20 relative z-50 ring-4 ring-gray-50 dark:ring-black/10 scale-[0.85] sm:scale-90 md:scale-100 origin-center mx-auto">
                ...
                >
                  <i className="fa-solid fa-triangle-exclamation"></i> Soporte Reactivo
                </button>
                <button
                ...
                >
                  <i className="fa-solid fa-circle-check"></i> Soporte Proactivo
                </button>
              </div>
            </div>
          </div>
              ...
              <div className={`bg-white dark:bg-[#0a0a0a] rounded-[2.25rem] sm:rounded-[2.5rem] w-full h-full md:min-h-[560px] lg:min-h-[600px] relative overflow-hidden flex flex-col border border-red-50 dark:border-[#a41e22]/10 shadow-[0_20px_60px_-15px_rgba(239,68,68,0.15)] transition-all duration-500 pb-3 sm:pb-4 md:pb-5
                ...
                <div className="bg-red-50/50 dark:bg-black/30 px-3 py-4 sm:px-4 sm:py-5 md:px-5 md:py-6 border-b border-red-50 dark:border-[#a41e22]/10 relative overflow-hidden">
                  <div className="relative z-10 flex flex-col gap-3">
                    ...
                    <p className="text-center text-[11px] sm:text-sm text-red-500/80 font-semibold max-w-xl mx-auto">
                      Llamadas desesperadas a programadores externos, tiempos de respuesta inciertos y caídas prolongadas.
                    </p>
                  </div>
                </div>
                ...
                <div className="p-2 sm:p-3 md:p-4 relative flex-1 flex flex-col rounded-[2rem] sm:rounded-[2.25rem] overflow-hidden">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 relative z-10 w-full h-full content-start">
                    {[
                      { title: "Respuestas Tardías", icon: "fa-clock", desc: "Espera de más de 24 horas por soporte" },
                      { title: "Pérdida de Ventas", icon: "fa-triangle-exclamation", desc: "El servidor se cae y nadie se entera" },
                      { title: "Sin Copias de Seguridad", icon: "fa-database", desc: "Riesgo extremo de perder info comercial" },
                      { title: "Sin Parches de Seguridad", icon: "fa-lock-open", desc: "Plugins y librerías desactualizados" },
                      { title: "Estrés Organizativo", icon: "fa-arrows-down-to-people", desc: "Llamadas de emergencia a programadores" },
                      { title: "Costos de Crisis", icon: "fa-dollar-sign", desc: "Cobros por incidentes imprevistos a precio alto" }
                    ].map((item, i) => (
                      <div
                        key={i}
            ...
            >
              <div className={`bg-gradient-to-br from-[#a41e22] to-[#7f1d1d] w-full h-full md:min-h-[560px] lg:min-h-[600px] relative overflow-hidden flex flex-col rounded-[2.25rem] sm:rounded-[2.5rem] shadow-2xl border border-white/20 transition-all duration-500 pb-3 sm:pb-4 md:pb-5
                ...
                <div className="bg-white/5 backdrop-blur-md px-3 py-4 sm:px-4 sm:py-5 md:px-5 md:py-6 border-b border-white/10 relative z-20 overflow-hidden">
                  <div className="relative z-10 flex flex-col gap-3">
                    ...
                    <p className="text-center text-[11px] sm:text-sm text-blue-50/90 font-semibold max-w-xl mx-auto">
                      Mesa de ayuda dedicada, SLA de respuesta en 2 horas y backups diarios.
                    </p>
                  </div>
                </div>
                ...
                <div className="p-2 sm:p-3 md:p-4 relative flex-1 flex flex-col rounded-[2rem] sm:rounded-[2.25rem] overflow-hidden">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 relative z-10 w-full h-full content-start">
                    {[
                      { title: "Respuesta en 2 Horas", icon: "fa-clock", desc: "SLA garantizado contractualmente" },
                      { title: "Monitoreo de Uptime 24/7", icon: "fa-chart-line", desc: "Alertas tempranas automáticas" },
                      { title: "Copias de Seguridad Diarias", icon: "fa-database", desc: "Copias cifradas seguras en la nube" },
                      { title: "Parches y Frameworks al Día", icon: "fa-screwdriver-wrench", desc: "Actualizaciones de seguridad periódicas" },
                      { title: "Tranquilidad Organizacional", icon: "fa-check", desc: "Ingenieros de guardia listos para resolver" },
                      { title: "Costo Mensual Predecible", icon: "fa-file-invoice-dollar", desc: "Plan fijo de soporte ilimitado" }
                    ].map((item, i) => (
                      <div
                        key={i}
...
export default SoporteActualizacion;
