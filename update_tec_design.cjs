...
const VERTICALS = [
  {
    ...
    desc: 'Interfaces reactivas de ultra baja latencia con React y Next.js. Enfocados en la conversin y UX.',
  ...
  {
    title: 'Cloud & Automatizacin',
    desc: 'Despliegues serverless y contenedores Docker para escalabilidad infinita y cero cadas.',
    icon: <Cloud size={32} className="text-[#A3E635]" />,
    tags: ['AWS', 'Docker', 'Webhooks']
  },
  {
    title: 'Inteligencia Artificial',
    desc: 'Modelos predictivos, RAG y agentes autnomos integrados directamente en tus flujos de trabajo.',
...
const TESTIMONIOS = [
  { name: 'TechSolutions Corp', role: 'CTO', text: 'La arquitectura en la nube que implementaron redujo nuestros costos de servidores en un 40% y mejor la velocidad.' },
  { name: 'StartUp Innova', role: 'Founder', text: 'El desarrollo de nuestra MVP fue rapidsimo. El cdigo es limpio y altamente escalable para nuestras futuras rondas.' },
  { name: 'Agencia Digital', role: 'Director de Operaciones', text: 'Automatizaron nuestros CRMs con IA, ahora nuestro equipo de ventas se enfoca slo en cerrar, no en hacer clics.' }
];

const TerminalWindow = () => {
  const [text, setText] = useState('');
  const fullText = `> Iniciando sistema HagamosTech...\n> Conectando a nodos globales... OK\n> Desplegando arquitectura cloud... OK\n> Entrenando modelo IA local... 100%\n> Sistema listo. Qu vamos a construir hoy?\n$`;
    ...
    <div className="dark relative overflow-hidden min-h-screen bg-[#050505] font-montserrat">
      ...
      <section className="relative pt-32 pb-20 z-10 px-6">
        <div className="container mx-auto max-w-7xl text-center flex flex-col items-center">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[#A3E635]/30 bg-[#A3E635]/10 text-xs font-black uppercase tracking-widest text-[#A3E635] mb-8 animate-fade-in-up">
            <i className="fa-solid fa-microchip"></i> Ncleo Tecnolgico
          </div>
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-black text-white leading-tight mb-6 animate-fade-in-up uppercase tracking-tighter" style={{ animationDelay: '0.1s' }}>
            Innovacin en <br/>
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#A3E635] to-[#84CC16]">Cdigo Puro</span>
          </h1>
          
          <p className="text-slate-400 text-lg max-w-2xl font-medium mb-10 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
            Construimos ecosistemas digitales de alto rendimiento. Desde arquitecturas web robustas hasta agentes de inteligencia artificial y automatizacin empresarial avanzada.
          </p>

          <div className="flex flex-wrap gap-4 justify-center animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
            <a href="https://wa.me/59161320004?text=Hola,%20busco%20una%20solucin%20tecnolgica%20avanzada" target="_blank" rel="noopener noreferrer" className="px-8 py-4 bg-[#A3E635] text-black font-black text-xs uppercase tracking-widest rounded-xl hover:bg-[#84CC16] transition-all hover:scale-105 shadow-lg shadow-[#A3E635]/20 flex items-center gap-2">
      ...
      <section className="py-10 border-y border-neutral-900 bg-neutral-950/50 z-10 relative">
        <div className="container mx-auto px-6">
          <p className="text-center text-xs font-black text-neutral-500 uppercase tracking-widest mb-6">Stack Tecnolgico y Herramientas</p>
        ...
        <div className="container mx-auto max-w-5xl">
          <div className="p-12 md:p-20 rounded-[3rem] bg-[#A3E635] text-black text-center relative overflow-hidden">
            ...
            <h2 className="text-4xl md:text-6xl font-black mb-6 relative z-10 uppercase tracking-tighter">
              El futuro de tu empresa se escribe en cdigo.
            </h2>
            <p className="text-lg md:text-xl font-bold opacity-80 mb-10 max-w-2xl mx-auto relative z-10">
              Desarrollemos la solucin tecnolgica que tu negocio necesita para liderar el mercado maana.
            </p>
...
fs.writeFileSync('src/pages/QueHacemos/Tecnologia/Tecnologia.jsx', componentCode, 'utf8');
console.log("Component updated with innovative design!");
