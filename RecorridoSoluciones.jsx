...
const PROJECTS = [
  {
    num: '01',
    category: 'AI/ML',
    firstPart: 'Dashboard con',
    highlightPart: 'Machine Learning',
    desc: 'Plataforma de análisis de datos con modelos predictivos integrados para prever ventas, detectar anomalías y sugerir decisiones estratégicas de negocio.',
  ...
  },
  {
    num: '02',
    category: 'AI-BOT',
    firstPart: 'Asistente de',
    highlightPart: 'IA Interno',
    desc: 'Bot conversacional entrenado con la base de conocimientos documental de tu empresa, accesible por los empleados para consultar políticas o resolver dudas al instante.',
  ...
  },
  {
    num: '03',
    category: 'LOGISTICS',
    firstPart: 'Plataforma de',
    highlightPart: 'Digitalización Logística',
    desc: 'Sistema complejo de ruteo y seguimiento vehicular en tiempo real con optimización de trayectorias e integración IoT de sensores vehiculares.',
  ...
  },
  {
    num: '04',
    category: 'MOBILE APP',
    firstPart: 'Aplicación Móvil',
    highlightPart: 'a Medida',
    desc: 'Desarrollo nativo o multiplataforma para necesidades sumamente específicas, como control de maquinaria industrial o herramientas de trabajo en campo offline.',
...
export default RecorridoSoluciones;
