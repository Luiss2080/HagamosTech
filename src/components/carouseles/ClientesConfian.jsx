...
const TrustedClients = () => {
  ...
  return (
    <section className="pt-0 pb-16 bg-transparent relative z-10 w-full overflow-hidden reveal">
      ...
      <div className="absolute top-[30%] left-[20%] w-[350px] h-[350px] bg-[#a41e22]/5 rounded-full blur-[120px] pointer-events-none"></div>
      <div className="absolute bottom-[20%] right-[20%] w-[350px] h-[350px] bg-[#c5a059]/5 rounded-full blur-[120px] pointer-events-none"></div>

      <div className="w-full relative">
        
        {/* Title */}
        <div className="text-center mb-4 px-6">
          <h2 className="text-2xl sm:text-3xl md:text-3xl lg:text-4xl font-black text-[#111827] leading-none">
            Clientes y marcas que <span className="text-[#a41e22] relative inline-block">conf├â┬¡an en nosotros<svg className="absolute w-full h-3 -bottom-1.5 left-0 z-[-1] text-amber-500 drop-shadow-[0_0_8px_rgba(245,158,11,0.55)]" viewBox="0 0 200 12" preserveAspectRatio="none" fill="none"><path d="M8,8 C22,5 38,7.5 55,7.5 C130,7.5 165,7.5 188,7.5 C194,7.5 198,6 196,7.5" stroke="currentColor" strokeWidth="7" strokeLinecap="round" /></svg></span>
          </h2>
        </div>
        ...
        <div className="flex flex-col gap-6 w-full relative">
          ...
          <div className="absolute top-0 bottom-0 left-0 w-16 sm:w-32 bg-gradient-to-r from-white to-transparent z-20 pointer-events-none"></div>
          <div className="absolute top-0 bottom-0 right-0 w-16 sm:w-32 bg-gradient-to-l from-white to-transparent z-20 pointer-events-none"></div>

          {/* Left/Right Overlapping Arrow Buttons positioned on outer margins */}
          <button className="absolute left-4 top-[24%] z-30 w-11 h-11 rounded-full bg-white border border-slate-200 shadow-2xl flex items-center justify-center text-[#a41e22] hover:scale-105 transition-all">
            <ChevronLeft size={18} />
          </button>
          <button className="absolute right-4 top-[24%] z-30 w-11 h-11 rounded-full bg-white border border-slate-200 shadow-2xl flex items-center justify-center text-[#a41e22] hover:scale-105 transition-all">
            <ChevronRight size={18} />
          </button>

          <button className="absolute left-4 top-[76%] z-30 w-11 h-11 rounded-full bg-white border border-slate-200 shadow-2xl flex items-center justify-center text-[#a41e22] hover:scale-105 transition-all">
            <ChevronLeft size={18} />
          </button>
          <button className="absolute right-4 top-[76%] z-30 w-11 h-11 rounded-full bg-white border border-slate-200 shadow-2xl flex items-center justify-center text-[#a41e22] hover:scale-105 transition-all">
            <ChevronRight size={18} />
          </button>
              ...
              {marqueeRow1.map((client, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="h-[80%] w-[2px] bg-[#a41e22]/50 mx-2 flex-shrink-0 group-hover:bg-[#a41e22]/80 transition-colors duration-500" />
                    ...
                    <div className="flex-1 h-full flex flex-col justify-between items-center text-center py-0.5">
                      <div className="flex flex-col items-center justify-center w-full gap-0.5 my-auto">
                        <div className="flex items-center justify-center gap-1.5 w-full">
                          <span className="text-[10px] font-black text-[#a41e22]">
                            {indexNum}
                          </span>
                        ...
                        <div className="flex items-center justify-center gap-1 text-slate-500 max-w-full leading-tight">
                          <i className={`fa-solid ${client.icon} text-[#c5a059] text-[8px]`}></i>
                        ...
                        <div className="flex items-center justify-center gap-1 mt-0.5 leading-tight">
                          ...
                          <span className="text-[8px] font-black text-[#c5a059] uppercase tracking-wider">
                            {client.metric}
                          </span>
                        </div>
                      </div>
                      ...
                      <button
                        ...
                        className="w-full py-1.5 rounded-lg bg-[#a41e22] text-white hover:bg-[#801015] border border-transparent text-[8.5px] font-black uppercase tracking-wider transition-all duration-300 flex items-center justify-center gap-2 shadow-md shadow-[#a41e22]/15 hover:-translate-y-0.5 active:scale-95 cursor-pointer"
                      >
