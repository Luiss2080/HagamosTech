...
const RecuperarContrasena = () => {
    ...
    return (
        <div className="relative overflow-hidden min-h-screen bg-[#111827] pt-20 font-montserrat">
            <CircuitBackground />
            ...
            <div className="relative z-10 container mx-auto px-6 pb-16">
                <div className="mx-auto w-full max-w-5xl grid grid-cols-1 lg:grid-cols-2 overflow-hidden rounded-[2.5rem] bg-[#111827] shadow-2xl border border-gray-200 animate-fade-in-up">
                        ...
                        <div className="relative z-10 flex flex-col items-center text-center">
                            <div className="mb-5 inline-flex items-center justify-center rounded-full bg-white/20 p-2.5 shadow-2xl ring-[0.5px] ring-white backdrop-blur-md">
                                <img
                                    ...
                                    loading="lazy"
                                    decoding="async"
                                    className="h-40 w-40 rounded-full object-contain bg-[#111827]"
                                />
                            </div>
                            ...
                            <p className="text-sm text-white/90 font-medium max-w-sm leading-relaxed mb-6 drop-shadow-md">
                                Crea una contraseña nueva y segura para volver a disfrutar de tus servicios y soluciones de software.
                            </p>

                            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#111827] border border-[#A3E635]/30 text-[#A3E635] text-[10px] font-black uppercase tracking-widest mb-6 shadow-lg">
                                <span className="w-2 h-2 rounded-full bg-[#A3E635] animate-ping"></span> Soporte HAGAMOSTECH 24/7
                            </div>
                    ...
                    <div className="relative flex flex-col justify-center bg-[#111111] p-6 lg:p-8">
                        <div className="absolute inset-0 overflow-hidden pointer-events-none">
                            <div className="absolute -top-10 -right-10 w-64 h-64 bg-[#0A0A0A]/10 rounded-full blur-3xl"></div>
                            <div className="absolute top-1/2 -left-10 w-40 h-40 bg-[#111827]/20 rounded-full blur-2xl"></div>
                            <div className="absolute bottom-0 right-10 w-56 h-56 bg-[#0A0A0A]/10 rounded-full blur-3xl"></div>
                        </div>
                        ...
                        <div className="relative z-10 w-full max-w-[520px] mx-auto">
                            ...
                            {exito ? (
                                <div className="text-center py-4">
                                    ...
                                    <h3 className="text-base font-black text-white uppercase tracking-wider mb-2">¡Listo!</h3>
                                ...
                                <form onSubmit={handleSubmit} className="flex flex-col gap-3.5" autoComplete="off">
                                    <div className="rounded-2xl border border-gray-200 bg-[#111827] p-4 shadow-sm">
                                        <div className="relative group mb-3">
                                            <input
                                                ...
                                                required
                                            />
                                            <label className="absolute top-3.5 left-12 z-10 origin-[0] -translate-y-2.5 scale-75 transform text-[9px] text-gray-400 font-black uppercase tracking-widest duration-300 peer-placeholder-shown:translate-y-0 peer-placeholder-shown:scale-100 peer-placeholder-shown:text-[10px] peer-placeholder-shown:font-bold peer-focus:-translate-y-2.5 peer-focus:scale-75 peer-focus:text-[#0A0A0A]">Nueva contraseña</label>
                                            <div className="absolute top-0 bottom-0 left-0 flex items-center justify-center w-12 text-gray-400 peer-focus:text-[#0A0A0A] transition-colors duration-300"><i className="fas fa-lock text-base"></i></div>
                                        </div>
                                        <div className="relative group">
                                            <input
                                                ...
                                                required
                                            />
                                            <label className="absolute top-3.5 left-12 z-10 origin-[0] -translate-y-2.5 scale-75 transform text-[9px] text-gray-400 font-black uppercase tracking-widest duration-300 peer-placeholder-shown:translate-y-0 peer-placeholder-shown:scale-100 peer-placeholder-shown:text-[10px] peer-placeholder-shown:font-bold peer-focus:-translate-y-2.5 peer-focus:scale-75 peer-focus:text-[#0A0A0A]">Confirmar contraseña</label>
                                            <div className="absolute top-0 bottom-0 left-0 flex items-center justify-center w-12 text-gray-400 peer-focus:text-[#0A0A0A] transition-colors duration-300"><i className="fas fa-check-double text-base"></i></div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="text-center">
                                        <Link to="/" className="inline-flex items-center gap-1.5 text-[11px] font-black uppercase tracking-wide text-[#0A0A0A] hover:text-[#171717]">
