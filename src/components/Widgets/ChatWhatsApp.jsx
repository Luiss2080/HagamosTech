      ...
      <AnimatePresence mode="wait">
        {isOpen ? (
          <motion.div
            ...
            className="relative w-[calc(100vw-1.5rem)] max-w-[350px] bg-[#111827] rounded-[24px] shadow-[0_20px_40px_-10px_rgba(0,0,0,0.3)] overflow-hidden flex flex-col border border-white/10"
          ...
          >
            ...
            <div className="bg-[#008069] p-3 flex items-center justify-between relative z-20 shadow-sm">
              <div className="flex items-center gap-3">
                <div className="relative">
                  <div className="w-10 h-10 bg-[#111827] rounded-full flex items-center justify-center p-1 overflow-hidden">
            ...
            <div className="flex-1 relative flex flex-col bg-[#EFEAE2] overflow-hidden">
              ...
              <div className="flex-1 overflow-y-auto p-4 flex flex-col gap-3 relative z-10 whatsapp-scrollbar">
                <div className="flex justify-center mb-3 mt-1">
                  <span className="text-[11px] bg-[#E1F3FB] text-slate-300 px-3 py-1 rounded-md shadow-sm uppercase tracking-wide">Hoy</span>
                </div>
                  ...
                  {showWelcome && (
                    ...
                    >
                      <div className="flex flex-col relative max-w-[90%]">
                        ...
                        <div className="p-2.5 pb-1.5 text-[14.5px] leading-relaxed relative bg-[#111827] text-[#111B21] rounded-lg rounded-tl-none z-20 shadow-[0_1px_1px_rgba(0,0,0,0.1)]">
                  ...
                  {isTyping && (
                    ...
                    >
                      <div className="flex flex-col relative max-w-[90%]">
                        ...
                        <div className="px-4 py-3 relative bg-[#111827] rounded-lg rounded-tl-none flex items-center gap-1 z-20 shadow-[0_1px_1px_rgba(0,0,0,0.1)]">
            ...
            <form onSubmit={handleSendMessage} className="bg-[#F0F2F5] p-2.5 flex items-center gap-2 relative z-20">
              <button type="button" className="w-9 h-9 flex items-center justify-center text-slate-400 hover:text-slate-200 transition-colors shrink-0">
                <Smile size={24} />
              </button>
              <button type="button" className="w-9 h-9 flex items-center justify-center text-slate-400 hover:text-slate-200 transition-colors shrink-0 mr-1">
                <Paperclip size={24} />
              </button>
              
              <div className="flex-1 bg-[#111827] rounded-xl flex items-center shadow-sm">
                <input
                  type="text"
                  value={inputValue}
              ...
              {inputValue.trim() ? (
                ...
                <button
                  type="button"
                  className="w-10 h-10 rounded-full flex items-center justify-center transition-all shrink-0 text-slate-400 hover:text-slate-200"
                >
