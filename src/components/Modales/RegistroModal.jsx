                            ...
                            <div className="relative hidden lg:flex flex-col justify-center gap-6 p-6 lg:p-8 overflow-hidden bg-gradient-to-br from-[#050505] via-[#121212] to-[#0a0a0a] border-r border-[#A3E635]/10">
                                ...
                                <div className="relative z-10 flex flex-col items-center text-center">
                                    ...
                                    <p className="text-sm text-white/90 font-medium max-w-sm leading-relaxed mb-6 drop-shadow-md">
                                        Registra tu perfil para realizar tus pedidos, gestionar tus proyectos y descubrir las mejores soluciones tecnológicas.
                                    </p>
                                    ...
                                    <form onSubmit={handleVerificarCorreo} className="flex flex-col gap-3.5" autoComplete="off">
                                        <div className="rounded-2xl border border-gray-200 bg-white p-4 shadow-sm">
                                            ...
                                            <div className="mb-2">
                                                <input
                                                    ...
                                                    maxLength="6"
                                                    value={código}
                                                    onChange={(e) => { setCódigo(e.target.value.replace(/\D/g, '')); setVerifError(''); }}
                                        ...
                                        <div className="rounded-2xl border border-gray-200 bg-white p-3.5 shadow-sm">
                                            ...
                                            <button
                                                ...
                                                className="w-full mt-2 py-2.5 px-6 bg-[#8B4513] text-black font-black text-xs uppercase tracking-widest rounded-xl shadow-lg shadow-[#8B4513]/20 hover:shadow-[#8B4513]/40 hover:-translate-y-0.5 hover:bg-[#5D3A1F] transition-all duration-300 cursor-pointer disabled:opacity-50"
                                            >
                                    ...
                                    <form onSubmit={handleSubmit} className="flex flex-col gap-3.5" autoComplete="off">
                                        <div className="rounded-2xl border border-gray-200 bg-white p-4 shadow-sm">
                                            ...
                                            <div className="relative group mb-3">
                                                <input type="text" name="nombre" value={formData.nombre} onChange={handleChange} className="peer block w-full rounded-xl border-2 border-gray-100 bg-white px-4 pt-5 pb-1.5 pl-12 text-sm font-bold text-[#111827] focus:border-[#A3E635] focus:ring-[#A3E635] focus:ring-[#A3E635]/20 focus:outline-none transition-all duration-300 placeholder-transparent" placeholder="Nombre" required />
                                            ...
                                            <div className="relative group mb-3">
                                                <input type="tel" name="telefono" value={formData.telefono} onChange={handleChange} className="peer block w-full rounded-xl border-2 border-gray-100 bg-white px-4 pt-5 pb-1.5 pl-12 text-sm font-bold text-[#111827] focus:border-[#A3E635] focus:ring-[#A3E635] focus:ring-[#A3E635]/20 focus:outline-none transition-all duration-300 placeholder-transparent" placeholder="Telefono" required />
                                            ...
                                            <div className="relative group">
                                                <input type="password" name="confirmarContraseña" value={formData.confirmarContraseña} onChange={handleChange} className="peer block w-full rounded-xl border-2 border-gray-100 bg-white px-4 pt-5 pb-1.5 pl-12 text-sm font-bold text-[#111827] focus:border-[#A3E635] focus:ring-[#A3E635] focus:ring-[#A3E635]/20 focus:outline-none transition-all duration-300 placeholder-transparent" placeholder="Confirmar password" required />
                                        ...
                                        <div className="rounded-2xl border border-gray-200 bg-white p-3.5 shadow-sm">
                                            <button type="submit" disabled={isSubmitting} className="w-full py-3.5 px-6 bg-[#8B4513] text-black font-black text-base uppercase tracking-widest rounded-xl shadow-lg shadow-[#8B4513]/20 hover:shadow-[#8B4513]/40 hover:-translate-y-0.5 hover:bg-[#5D3A1F] transition-all duration-300 flex items-center justify-center gap-3 group active:scale-[0.96] relative overflow-hidden disabled:opacity-70 disabled:cursor-not-allowed">
