...
const ModalError = ({
    ...
    return (
        <div id="incorrectModal" className="tyr-modal fixed inset-0 z-[100]" aria-labelledby="modal-title" role="dialog" aria-modal="true">
                                ...
                                <div className="relative z-10 flex flex-col items-center text-center">
                                    <div className="mb-5 inline-flex items-center justify-center rounded-full bg-white/20 p-2.5 shadow-2xl ring-[0.5px] ring-white backdrop-blur-md relative">
                                        <div className="h-36 w-36 rounded-full bg-white flex items-center justify-center shadow-lg overflow-hidden transition-transform duration-500 hover:scale-105 hover:-translate-y-2 hover:rotate-[5deg]">
                                            <i className="fas fa-triangle-exclamation text-[#050505]" style={{ fontSize: '70px' }}></i>
                                        </div>
                                        <div className="absolute -bottom-1 -right-1 w-10 h-10 rounded-full bg-[#A3E635]/100 border-2 border-white flex items-center justify-center shadow-lg">
                                    ...
                                    <p className="text-sm text-white/90 font-medium max-w-sm leading-relaxed mb-5 drop-shadow-md">
                                        No se completo la accion. Verifica tus datos y vuelve a intentarlo.
                                    </p>
                            ...
                            <div className="relative flex flex-col justify-center h-full bg-[#F9F9F9] p-5 lg:p-6">
                                ...
                                <div className="relative z-10 w-full max-w-[540px] mx-auto">
                                    <div className="mb-3.5 text-center bg-white p-4 rounded-2xl shadow-sm border border-gray-200 relative overflow-hidden">
                                        ...
                                        <p className="text-xs text-gray-500 font-bold uppercase tracking-wide">Alerta</p>
                                    </div>
                                    ...
                                    <div className="rounded-2xl border border-[#A3E635]/30 bg-white p-4 shadow-sm">
                                        <div className="flex items-start gap-3">
                                            <span className="w-10 h-10 rounded-2xl bg-[#A3E635]/10 border border-[#A3E635]/30 text-red-500 flex items-center justify-center flex-shrink-0">
                                                <i className="fas fa-xmark text-base"></i>
                                            </span>
                                            <div>
                                                <p className="text-sm text-gray-600 font-semibold leading-relaxed">{message}</p>
                                                <div className="mt-3 inline-flex items-center gap-2 text-[11px] font-black uppercase tracking-widest text-red-500">
                                                    <span className="w-2 h-2 rounded-full bg-[#A3E635]/100"></span>
                                                    Se requiere accion
                                                </div>
                                            </div>
                                        </div>
