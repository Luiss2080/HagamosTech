                                ...
                                <div className="relative z-10 flex flex-col items-center text-center">
                                    <div className="mb-5 inline-flex items-center justify-center rounded-full bg-white/20 p-2.5 shadow-2xl ring-[0.5px] ring-white backdrop-blur-md">
                                        <div className="h-24 w-24 rounded-full bg-white flex items-center justify-center">
                                            <i className="fas fa-hourglass-half text-[4rem] text-[#FF4D00]"></i>
                                        </div>
                                    </div>
                                    ...
                                    <p className="text-sm text-white/90 font-medium max-w-sm leading-relaxed mb-6 drop-shadow-md">
                                        Recuerda que tienes un cupón de bienvenida esperando ser reclamado. ¡Úsalo antes de que finalice el tiempo!
                                    </p>
                                ...
                                <div className="relative z-10 w-full max-w-[540px] mx-auto">
                                    <div className="mb-3.5 text-center bg-white p-4 rounded-2xl shadow-sm border border-gray-200 relative overflow-hidden">
                                        ...
                                        <div className="inline-flex items-center gap-2 mb-1.5">
                                            ...
                                            <h3 className="text-2xl font-black text-[#111827] tracking-tight">Recordatorio de Cupón</h3>
                                        </div>
                                        <p className="text-xs text-gray-500 font-bold uppercase tracking-wide">EL TIEMPO SIGUE CORRIENDO</p>
                                    </div>
                                    ...
                                    <div className="mb-3.5 grid grid-cols-1 sm:grid-cols-3 gap-2.5">
                                        ...
                                        <div className="rounded-xl bg-white border border-[#5D3A1F]/40 px-3 py-2.5 text-center shadow-sm">
                                            ...
                                            <p className="text-[13px] font-extrabold text-[#111827]">Pendiente</p>
                                        </div>
                                    </div>

                                    <div className="flex flex-col gap-3.5">
                                        <div className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm text-center">
                                            <p className="text-xs font-bold text-gray-500 uppercase tracking-widest mb-2">Estado Actual</p>
                                            <h3 className="text-2xl font-black text-[#111827] mb-4">Tienes un regalo pendiente</h3>
                                            
                                            <div className="flex items-center justify-center gap-4 mb-4">
                                                <div className="text-6xl font-black text-[#FF4D00] tracking-tighter drop-shadow-sm">
                                                    {diasRestantes}
                                                </div>
                                                <div className="text-left flex flex-col justify-center">
                                                    <span className="text-2xl font-black text-[#FF4D00] uppercase tracking-wide leading-none mb-1">Día{diasRestantes > 1 ? 's' : ''}</span>
                                                    <span className="text-sm font-bold text-gray-400 uppercase tracking-widest">Restantes</span>
                                                </div>
                                            </div>
                                        </div>

                                        <div className="rounded-2xl border border-gray-200 bg-white p-3.5 shadow-sm">
                                            <button onClick={onClose} className="w-full py-3.5 px-6 bg-[#FF4D00] text-white font-black text-base uppercase tracking-widest rounded-xl shadow-lg shadow-[#FF4D00]/20 hover:shadow-[#FF4D00]/40 hover:-translate-y-0.5 hover:bg-[#D93D00] transition-all duration-300 flex items-center justify-center gap-3 group active:scale-[0.96] relative overflow-hidden">
                                                <span className="relative z-10">IR A RECLAMAR MI DESCUENTO</span>
                                        ...
                                        <div className="rounded-xl border border-gray-200 bg-white px-4 py-3 text-[11px] text-gray-500 font-semibold leading-relaxed flex items-center justify-center text-center">
                                            <div className="flex flex-col items-center gap-1 max-w-sm">
                                                ...
                                                <span className="text-justify">
                                                    Consejo: Reclama tu descuento antes de que se agote el tiempo, podrás aplicarlo de inmediato en tu primer pedido.
                                                </span>
                                            </div>
                                        </div>
                                    </div>
...
export default ModalRecordatorioInvitado;
