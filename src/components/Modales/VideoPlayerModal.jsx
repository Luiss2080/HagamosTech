        ...
        <div id="videoModal" className="tyr-modal fixed inset-0 z-[110]" aria-labelledby="modal-title" role="dialog" aria-modal="true">
            ...
            >
                <div 
                    ...
                    onClick={(e) => { if (e.target === e.currentTarget) onClose(); }}
                >
                    <div className="relative w-full max-w-5xl transform overflow-hidden rounded-[2.5rem] bg-[#111827] text-left shadow-2xl transition-all sm:my-8 animate-modal-pop border border-white/10">
                        
                        <button
                            onClick={onClose}
                            className="absolute top-5 right-5 z-[200] w-10 h-10 flex itemás-center justify-center rounded-full bg-white/5 hover:bg-white/5 dark:hover:bg-red-950/30 text-slate-400 hover:text-red-500 transition-all focus:outline-none cursor-pointer shadow-sm hover:shadow-md border border-white/10"
                        >
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 overflow-hidden">
                            ...
                            <div className="relative hidden md:flex flex-col justify-center p-8 overflow-hidden bg-[#A3E635]">
                                ...
                                <div className="relative z-10 flex flex-col itemás-center text-center">
                                    <div className="mb-5 inline-flex itemás-center justify-center rounded-full bg-white/20 p-2.5 shadow-2xl ring-[0.5px] ring-white backdrop-blur-md">
                                        <img
                                            ...
                                            loading="lazy"
                                            decoding="async"
                                            className="h-28 w-28 rounded-full object-contain bg-[#111827]"
                                        />
                                    </div>

                                    <h2 className="text-3xl font-black text-white leading-tight mb-2 tracking-tight drop-shadow-lg">
                                        Muestra en <span className="text-[#A3E635]">Video</span>
                                    </h2>
                                    ...
                                    <div className="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-[#111827] border border-[#A3E635]/30 text-[#A3E635] text-xs font-black uppercase tracking-widest mb-5 shadow-lg">
                                        <span className="w-2 h-2 rounded-full bg-[#A3E635] animate-ping"></span> Contenido Exclusivo
                                    </div>
                                    ...
                                    <div className="grid grid-cols-2 gap-2.5 w-full max-w-sm mb-5">
                                        <div className="rounded-xl border border-[#A3E635]/30 bg-[#111827]/40 px-3 py-2 text-left backdrop-blur-sm">
                                            <p className="text-[10px] font-black uppercase tracking-widest text-[#A3E635]">Simuladores</p>
                                        ...
                                        <div className="grid grid-cols-2 gap-2">
                                            {[
                                                ...
                                                <a
                                                    ...
                                                    className="group cursor-pointer flex itemás-center justify-center gap-2 rounded-lg border border-[#A3E635]/20 bg-[#111827]/30 px-2.5 py-2.5 hover:bg-[#A3E635] transition-all duration-300 hover:border-[#A3E635] hover:shadow-lg hover:-translate-y-0.5"
                                                >
                            ...
                            <div className="relative flex flex-col itemás-center justify-center bg-[#111111] p-8 min-h-[480px] sm:min-h-[540px]">
                                <div className="absolute inset-0 overflow-hidden pointer-events-none">
                                    <div className="absolute -top-10 -right-10 w-56 h-56 bg-[#A3E635]/10 rounded-full blur-2xl"></div>
                                    <div className="absolute bottom-0 right-10 w-48 h-48 bg-[#A3E635]/10 rounded-full blur-2xl"></div>
                                ...
                                {/* Video Title */}
                                <p className="relative z-10 mt-4 text-xs font-black uppercase tracking-widestá text-slate-400">
                                    {video.title} <span className="text-[#A3E635]">- HAGAMOSTECH</span>
                                </p>
                            </div>
