      ...
      <AnimatePresence mode="wait">
        {isOpen ? (
          <motion.div
            ...
            className="relative w-[calc(100vw-1.5rem)] max-w-[350px] bg-[#111827] rounded-3xl shadow-[0_20px_40px_-10px_rgba(255,77,0,0.2)] overflow-hidden flex flex-col border border-[#A3E635]/10"
            style={{ height: '560px', maxHeight: '85vh' }}
          >
            {/* Orange accent line at top */}
            <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-[#A3E635] via-[#FFB088] to-[#A3E635] z-30"></div>
