...
const Ubicacion = () => {
    const infoCards = [
        ...
        { icon: "fa-clock", title: "Horario", value: "Lun - Vie: 9:00 - 18:00", theme: "bg-[#111827] text-[#0A0A0A]", iconBg: "bg-neutral-100 text-[#0A0A0A]", shadow: "shadow-neutral-200/50", border: "border-neutral-200" },
        ...
        { icon: "fa-envelope", title: "Email", value: "contacto@hagamostech.bo", theme: "bg-[#111827] text-[#0A0A0A]", iconBg: "bg-neutral-100 text-[#0A0A0A]", shadow: "shadow-neutral-200/50", border: "border-neutral-200" }
    ];
    ...
    return (
        <section id="ubicación" className="relative z-10 py-4 border-t border-[#A3E635]/15">
            ...
            <div className="absolute bottom-0 left-0 w-full overflow-hidden leading-[0] rotate-180 opacity-25 z-0">
