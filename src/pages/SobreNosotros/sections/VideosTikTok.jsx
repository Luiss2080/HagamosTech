...
const initialVideos = [
  {
    ...
    views: 'Nuevo',
    desc: 'Disfruta de las mejores salteñas en Santa Cruz, horneadas diariamente con los mejores ingredientes.',
    thumb: 'bg-[#FF4D00]',
  },
  {
    id: 2,
    ...
    views: 'Popular',
    desc: 'La receta original desde 1989 que sigue cautivando paladares.',
    thumb: 'bg-[#111827]',
  },
  {
    id: 3,
    ...
    views: 'Tendencia',
    desc: 'Ven y prueba nuestro menú completo de salteñas, jugos y bebidas calientes.',
    thumb: 'bg-[#5D3A1F]',
  },
  {
    id: 4,
    ...
    views: 'Nuevo',
    desc: 'Seleccionamos los ingredientes más frescos para brindarte un sabor verdaderamente único.',
    thumb: 'bg-[#FF4D00]',
  },
  {
    id: 5,
    ...
    title: 'El Horneado',
    views: 'Destacado',
    desc: 'El secreto de nuestra masa perfecta y jugoso relleno al descubierto.',
    thumb: 'bg-[#8B4513]',
  },
];
                ...
                <div className="w-full px-4 md:px-8 relative z-20">
                    ...
                    <div className="text-center mb-4">
                        ...
                        <p className="text-[#1F2937] font-medium max-w-2xl mx-auto text-base sm:text-lg leading-relaxed">
                            Conoce cómo elaboramos nuestras deliciosas salteñas, demostraciones de nuestros sabores y el trabajo diario para llevar lo mejor a tu mesa.
                        </p>
                    </div>
                                ...
                                >
                                    ...
                                    >
                                        <div className={isActive && lastSelectedId === video.id ? 'animate-spin-lr' : ''} style={{ transformStyle: 'preserve-3d' }}>
                                            <div className={`w-full bg-white rounded-[2.5rem] p-4.5 shadow-2xl transition-all duration-300 ${isActive ? 'border-2 border-[#FF4D00] shadow-[0_0_25px_rgba(255,77,0,0.35)]' : 'border border-gray-100 hover:border-[#FF4D00]/40'}`}>
                                                ...
                                                <div className="absolute left-4 top-4 z-30 bg-[#FF4D00] text-white px-3 py-1 rounded-full text-[9px] font-black uppercase tracking-wider shadow-md flex items-center gap-2">
                                            ...
                                            <div className="mt-4 px-1">
                                                <div className="flex items-center justify-between gap-2 mb-2">
                                                    <span className="inline-flex items-center gap-2 rounded-full bg-[#FF4D00]/10 text-[#FF4D00] px-3 py-1 text-[10px] font-black uppercase tracking-widest">
