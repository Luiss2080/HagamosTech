...
const RESUMEN = [
    { icon: 'fa-file-signature', titulo: 'Aceptación al usar', desc: 'Al navegar nuestro sitio o realizar un pedido, aceptás automáticamente estos términos de servicio.', color: 'bg-[#FF4D00]' },
    { icon: 'fa-boxes-stacked', titulo: 'Productos frescos', desc: 'Todos nuestros productos se preparan al día. Los pedidos dependen de la disponibilidad del día.', color: 'bg-[#5D3A1F]' },
    { icon: 'fa-hand-holding-dollar', titulo: 'Pagos seguros', desc: 'Los pagos se procesan al momento de confirmar el pedido. Aceptamos efectivo, QR y transferencias.', color: 'bg-[#8B4513]' },
    { icon: 'fa-rotate', titulo: 'Política de cambios', desc: 'Los pedidos pueden cancelarse hasta 30 minutos antes de la entrega. Detalles en esta página.', color: 'bg-[#CC3D00]' },
];
                ...
                <div className="container mx-auto px-6 max-w-7xl relative z-20">
                    <div className="text-center mb-4 relative z-10">
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl font-black font-heading text-[#8B4513] mb-3 leading-tight">
                            En resumen, estas <span className="relative inline-block text-[#FF4D00]">
                                reglas
                            ...
                            <div key={i} className={`relative rounded-[2rem] p-6 transition-all duration-500 group overflow-hidden border hover:-translate-y-1.5 z-10 text-center ${item.color} text-white shadow-xl shadow-orange-950/10`}>
                                ...
                                <div className="relative z-10">
                                    ...
                                    <div className="mt-4 pt-3 border-t border-white/25 inline-flex items-center gap-1.5 text-[9px] font-black uppercase tracking-widest opacity-80">
                                        <i className="fas fa-file-contract text-[9px]"></i> Los Castores
                                    </div>
                                </div>
                            </div>
                        ))}
