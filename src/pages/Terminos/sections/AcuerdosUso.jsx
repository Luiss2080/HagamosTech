                ...
                <div className="container mx-auto px-6 max-w-7xl relative z-20">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 items-stretch">
                        ...
                        <div className="lg:col-span-4 flex flex-col gap-4">
                            <div className="bg-[#111827] rounded-[2rem] ring-1 ring-gray-100 shadow-xl shadow-black/5 relative overflow-hidden">
                                        ...
                                        {ACUERDOS.map((cl, i) => {
                                            ...
                                            return (
                                                <button
                                                    ...
                                                    className={`w-full flex items-center gap-3 p-3 rounded-xl border text-left transition-all duration-300 ${isOpen ? `${cl.soft} shadow-sm scale-[1.01]` : 'bg-[#111827] border-white/10 hover:border-white/10 hover:bg-[#F8FAF5]'}`}
                                                >
                        ...
                        <div className="lg:col-span-8 flex flex-col gap-3">
                            {ACUERDOS.map((cl, i) => {
                                const isOpen = abierta === i;
                                return (
                                    <div key={i} className={`relative rounded-[2rem] overflow-hidden transition-all duration-300 ${isOpen ? 'bg-[#111827] shadow-xl ring-2 ring-[#A3E635]/20' : 'bg-[#111827] ring-1 ring-gray-100 shadow-md hover:shadow-lg'}`}>
                                        ...
                                        <button onClick={() => setAbierta(isOpen ? null : i)} className="relative w-full flex items-center gap-4 p-5 text-left cursor-pointer">
                                            ...
                                            <div className="flex-1">
                                                ...
                                                <p className="text-[11px] text-slate-300 font-semibold">{cl.ejemplo}</p>
                                            </div>
                                            <span className={`w-8 h-8 rounded-full flex items-center justify-center border transition-all ${isOpen ? `${cl.color} text-white border-transparent rotate-180` : 'border-white/10 text-[#84CC16]'}`}>
                                        ...
                                        {isOpen && (
                                            <div className="relative px-5 pb-5 pl-[76px] animate-fade-in">
                                                <div className="mb-3 border-t border-dashed border-white/10 pt-3">
                                                    <p className="text-[12px] text-slate-300 font-semibold leading-relaxed">{cl.detalles}</p>
                                                </div>
