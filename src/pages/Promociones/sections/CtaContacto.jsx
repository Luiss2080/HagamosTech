                    ...
                    <div className="bg-gradient-to-br from-[#A3E635] via-[#84CC16] to-[#0A0A0A] rounded-[2.5rem] p-8 sm:p-12 text-center shadow-2xl shadow-lime-400/20/25 relative overflow-hidden">
                        ...
                        <div className="relative z-10">
                            <div className="w-16 h-16 rounded-full bg-white/15 border border-white/25 flex items-center justify-center mx-auto mb-4 shadow-xl animate-bounce-slow">
                                <i className="fas fa-fire text-2xl text-lime-300"></i>
                            </div>
                            ...
                            <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/15 text-white px-4 py-1.5 text-[10px] font-black tracking-[0.2em] uppercase border border-white/25 backdrop-blur-sm mb-3">
                                <i className="fas fa-bolt mr-1.5 text-lime-300"></i> Aprovechá hoy
                            </span>
                            ...
                            <div className="flex flex-wrap justify-center gap-3">
                                <a href="https://wa.me/59161320004" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2.5 px-8 py-4 bg-[#25D366] hover:bg-[#1DA851] text-white rounded-full font-black text-xs uppercase tracking-[0.15em] shadow-xl hover:shadow-2xl hover:-translate-y-1 active:scale-95 transition-all duration-300">
                                    <i className="fab fa-whatsapp text-xl"></i> Escribinos por WhatsApp
                                </a>
                                <a href="tel:+59161320004" className="inline-flex items-center gap-2.5 px-8 py-4 bg-[#111827] text-[#A3E635] rounded-full font-black text-xs uppercase tracking-[0.15em] shadow-xl hover:shadow-2xl hover:-translate-y-1 active:scale-95 transition-all duration-300">
                            ...
                            <div className="mt-8 flex flex-wrap items-center justify-center gap-4 sm:gap-6 text-white/70">
                                <div className="inline-flex items-center gap-2 text-[10px] font-black uppercase tracking-widest"><i className="fas fa-bolt text-lime-300 text-lg"></i> Respuesta en el día</div>
                                <div className="inline-flex items-center gap-2 text-[10px] font-black uppercase tracking-widest"><i className="fas fa-certificate text-lime-300 text-lg"></i> Presupuesto sin cargo</div>
                                <div className="inline-flex items-center gap-2 text-[10px] font-black uppercase tracking-widest"><i className="fas fa-shield-alt text-lime-300 text-lg"></i> Soporte continuo</div>
                            </div>
                        </div>
                    </div>
                </div>
