                    ...
                    <div className="bg-gradient-to-br from-[#FF4D00] via-[#CC3D00] to-[#8B4513] rounded-[2.5rem] p-8 sm:p-12 text-center shadow-2xl shadow-orange-500/25 relative overflow-hidden">
                        ...
                        <div className="relative z-10">
                            ...
                            <div className="mt-8 flex flex-wrap items-center justify-center gap-4 sm:gap-6 text-white/70">
                                <div className="inline-flex items-center gap-2 text-[10px] font-black uppercase tracking-widest"><i className="fas fa-bolt text-amber-300 text-lg"></i> Respuesta en el día</div>
                                <div className="inline-flex items-center gap-2 text-[10px] font-black uppercase tracking-widest"><i className="fas fa-certificate text-amber-300 text-lg"></i> Presupuesto sin cargo</div>
                                <div className="inline-flex items-center gap-2 text-[10px] font-black uppercase tracking-widest"><i className="fas fa-shield-alt text-amber-300 text-lg"></i> Soporte continuo</div>
                            </div>
                        </div>
                    </div>
                </div>
