...
const PROJECTS = [
  {
    ...
    desc: 'Creación de marcas memorables, desde isologotipos hasta manuales de marca para servicios técnicos, restaurantes o corporaciones.',
  ...
  },
  {
    ...
    desc: 'Gráficos publicitarios de alto impacto en formato cuadrado (4x4) y gran formato para exposiciones, pancartas o Instagram.',
  ...
  },
  {
    ...
    highlightPart: 'Catálogos',
    desc: 'Diseño de empaques sostenibles, etiquetas atractivas y maquetación de catálogos impresos para destacar tus productos físicos.',
    tags: ['Packaging', 'Catálogos', 'Impresión'],
    icon: 'fa-box-open',
    images: [
  ...
  },
  {
    ...
    desc: 'Tarjetas de presentación corporativas elegantes (opción con código QR integrado) e invitaciones digitales/impresas para eventos.',
  ...
  },
  {
    ...
    firstPart: 'Edición',
    highlightPart: 'Fotográfica',
    desc: 'Mejora de calidad de imagen, corrección de color profesional y eliminación de fondos para catálogos de comercio electrónico.',
    tags: ['Retoque', 'Fotografía', 'Photoshop'],
