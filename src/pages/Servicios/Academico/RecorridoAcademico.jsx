...
const TECH_DETAILS = {
  ...
  'AWS': { icon: 'fa-brands fa-aws', color: 'text-[#A3E635] dark:text-lime-300', bg: 'bg-[#A3E635]/10 dark:bg-amber-950/20', border: 'border-amber-100 dark:border-amber-900/30' },
  ...
  'Git': { icon: 'fa-brands fa-git-alt', color: 'text-orange-600 dark:text-orange-500', bg: 'bg-white/5 dark:bg-orange-950/20', border: 'border-white/10 dark:border-orange-900/30' },
  ...
  'Next.js': { icon: 'fa-solid fa-n', color: 'text-white dark:text-gray-200', bg: 'bg-white/5 dark:bg-gray-800/40', border: 'border-gray-300 dark:border-gray-700/50' },
...
const PROJECTS = [
  {"num":"01","category":"TESIS Y MONOGRAFÍAS","firstPart":"Monografías","highlightPart":"y Tesis","desc":"Estructuración de monografías, tesis y documentos bajo formato APA 7 con rigor académico.","tags":["APA 7","Documentación","Word"],"icon":"fa-book","images":["https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?auto=format&fit=crop&w=800&q=80","https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&w=800&q=80","https://images.unsplash.com/photo-1522071820081-009f0129c71c?auto=format&fit=crop&w=800&q=80","https://images.unsplash.com/photo-1498050108023-c5249f4df085?auto=format&fit=crop&w=800&q=80","https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&w=800&q=80"]},
  {"num":"02","category":"PRESENTACIONES","firstPart":"Presentaciones","highlightPart":"Interactivas","desc":"Defensas de tesis y exposiciones con presentaciones dinámicas y visualmente impactantes.","tags":["PowerPoint","Interactivo","Diseño"],"icon":"fa-file-powerpoint","images":["https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?auto=format&fit=crop&w=800&q=80","https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&w=800&q=80","https://images.unsplash.com/photo-1522071820081-009f0129c71c?auto=format&fit=crop&w=800&q=80","https://images.unsplash.com/photo-1498050108023-c5249f4df085?auto=format&fit=crop&w=800&q=80","https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&w=800&q=80"]},
  {"num":"03","category":"DIAGRAMAS","firstPart":"Infografías","highlightPart":"y Diagramas","desc":"Esquemas anatómicos, flujos de bases de datos y líneas de tiempo para visualizar tu investigación.","tags":["Infografías","Diagramas","Esquemas"],"icon":"fa-project-diagram","images":["https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?auto=format&fit=crop&w=800&q=80","https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&w=800&q=80","https://images.unsplash.com/photo-1522071820081-009f0129c71c?auto=format&fit=crop&w=800&q=80","https://images.unsplash.com/photo-1498050108023-c5249f4df085?auto=format&fit=crop&w=800&q=80","https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&w=800&q=80"]},
  {"num":"04","category":"SIMULACIÓN","firstPart":"Simuladores","highlightPart":"y Programación","desc":"Simuladores educativos, proyectos de redes y apoyo en lógica de programación.","tags":["Simuladores","Redes","Código"],"icon":"fa-code","images":["https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?auto=format&fit=crop&w=800&q=80","https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&w=800&q=80","https://images.unsplash.com/photo-1522071820081-009f0129c71c?auto=format&fit=crop&w=800&q=80","https://images.unsplash.com/photo-1498050108023-c5249f4df085?auto=format&fit=crop&w=800&q=80","https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&w=800&q=80"]}
];
...
const ProjectCarousel = ({ images }) => {
  ...
  return (
    <div className="relative w-full aspect-[16/10] sm:aspect-[16/9.5] rounded-[2.2rem] overflow-hidden shadow-2xl border border-[#A3E635]/15 hover:border-[#84CC16]/30 bg-[#121212] group transition-all duration-500">
      ...
      <button
        onClick={handlePrev}
        className="absolute left-4 top-1/2 -translate-y-1/2 w-11 h-11 rounded-2xl bg-[#0A0A0A]/95 dark:bg-[#0a0a0a]/95 border border-neutral-200/60 dark:border-neutral-800 shadow-xl flex items-center justify-center text-[#0A0A0A] dark:text-white transition-all opacity-0 group-hover:opacity-100 hover:scale-110 active:scale-95 hover:bg-[#A3E635] hover:text-[#0A0A0A] z-20 cursor-pointer"
      >
        <ChevronLeft size={16} />
      </button>
      <button
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-3xl md:text-4xl font-black text-white dark:text-white mb-6 leading-none">
            ...
            <span className="text-[#A3E635] dark:text-[#A3E635] relative inline-block">
              Apoyo Académico.<svg className="absolute w-full h-4 -bottom-2 left-0 z-[-1] text-[#84CC16]" viewBox="0 0 200 9" fill="none"><path d="M2.00025 6.99997C25.7509 4.50435 65.2536 2.07897 197.994 4.4151" stroke="currentColor" strokeWidth="6" strokeLinecap="round" strokeLinejoin="round"/></svg>
            </span>
          </h2>
          <p className="text-sm sm:text-base text-slate-400 dark:text-slate-400 font-semibold leading-relaxed max-w-2xl mx-auto mb-8 text-center justify-center">
            Proyectos académicos estructurados con rigor: monografías, presentaciones, infografías, simuladores y programación.
          </p>
        </div>
