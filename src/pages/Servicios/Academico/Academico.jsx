...
const BRANDS = [
  {"name":"Monografías y Tesis","tag":"Formato APA 7 y documentación","icon":"fa-book"},
  {"name":"Presentaciones","tag":"PowerPoint e interactivas","icon":"fa-file-powerpoint"},
  {"name":"Infografías y Diagramas","tag":"Esquemas y líneas de tiempo","icon":"fa-project-diagram"},
  {"name":"Simuladores y Robótica","tag":"Entornos virtuales educativos","icon":"fa-shapes"},
  {"name":"Proyectos de Redes","tag":"Topologías y pruebas","icon":"fa-network-wired"},
  {"name":"Programación","tag":"Apoyo en código y lógica","icon":"fa-code"}
];

const PROCESO = [
  {"title":"Planificación","desc":"Analizamos tu proyecto, los requisitos de la materia y los objetivos de la defensa para definir el plan de trabajo."},
  {"title":"Contenido y Diseño","desc":"Estructuramos marco teórico, esquemas, infografías y presentaciones bajo normas académicas (APA 7)."},
  {"title":"Desarrollo y Simulación","desc":"Construimos simuladores, proyectos de redes o código estructurado cuando la tarea lo requiere."},
  {"title":"Entrega y Ajustes","desc":"Entregamos el trabajo funcional con revisión final, corrección de estilo y acompañamiento pre-defensa."}
];
...
const TESTIMONIOS = [
  ...
  {"name":"Prof. Ana Torres","role":"Docente Universitaria","text":"Los simuladores educativos y los diagramas de procesos mejoraron muchísimo la comprensión de mis alumnos."},
  {"name":"Felipe Guzmán","role":"Tesista de Ingeniería","text":"Su asesoría en formato APA 7 y lógica de programación estructurada me salvó el proyecto de grado. Muy rigurosos."}
];
...
const VALUE_POINTS = [
  {"icon":"fa-file-powerpoint","label":"Presentaciones Profesionales"},
  {"icon":"fa-book","label":"Formato APA 7"},
  {"icon":"fa-shapes","label":"Simuladores y Redes"},
  {"icon":"fa-award","label":"Rigor Académico"}
];
        ...
        <div className="container mx-auto px-6 max-w-7xl relative z-10 flex flex-col items-center">
          ...
          <div className="flex items-center gap-2 mb-5">
              <span className="inline-flex items-center px-4 py-1.5 rounded-full border border-[#A3E635]/45 bg-[#A3E635]/10 text-[9.5px] font-black uppercase tracking-widest text-[#A3E635] shadow-sm leading-none">
                  <i className="fa-solid fa-laptop-code mr-1.5"></i> Apoyo Académico — HagamosTech
              </span>
          </div>
...
<span className="block whitespace-nowrap">para tus proyectos. <span className="text-[#A3E635] relative inline-block z-10">rigor académico.<svg className="absolute w-full h-4 -bottom-2 left-0 z-[-1] text-[#84CC16]" viewBox="0 0 200 9" fill="none"><path d="M2.00025 6.99997C25.7509 4.50435 65.2536 2.07897 197.994 4.4151" stroke="currentColor" strokeWidth="6" strokeLinecap="round" strokeLinejoin="round"/></svg></span></span>
</h1>

              <p className="text-base sm:text-lg font-bold text-slate-300 dark:text-slate-300 leading-relaxed max-w-xl text-center">
                Orientadas a estudiantes universitarios, docentes e instituciones que requieren estructurar, simular y presentar proyectos con alto rigor académico.
              </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-6 text-center flex flex-col items-center justify-center">
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-white dark:text-white uppercase leading-tight mb-6 tracking-tighter">
                ¿QUÉ ES EL APOYO ACADÉMICO Y CÓMO AYUDA A TU PROYECTO?
              </h2>
...
<p>
Asesoramos la estructuración, simulación y presentación de tus proyectos académicos con alto rigor, desde monografías y tesis hasta simuladores de redes, robótica educativa y sistemas informáticos.
</p>
<p>
<span className="font-black uppercase tracking-widest text-[#A3E635] dark:text-[#A3E635]">Servicios Específicos: </span>
Presentaciones PowerPoint e Interactivas, Formato APA 7 y Documentación Técnica, Infografías y Diagramas, Mapas Conceptuales y Portadas Académicas, Simuladores Educativos y Proyectos de Redes, y Apoyo en Proyectos de Programación.
</p>
</div>
            </div>
              ...
              <div className="bg-[#1e1e1e] rounded-3xl shadow-2xl border border-neutral-800 overflow-hidden text-left relative group">
                ...
                <div className="bg-[#252526] p-3 flex items-center justify-between border-b border-neutral-900">
                  <div className="flex items-center gap-1.5">
                    ...
                    <span className="text-[10px] text-slate-400 font-bold ml-2 font-mono">academico.js</span>
                  </div>
                ...
                <div className="absolute top-1/2 -right-4 translate-y-[-50%] flex flex-col gap-3 z-20">
                  <div className="w-12 h-12 bg-neutral-900/50 dark:bg-neutral-900 border border-white/10 dark:border-neutral-800 rounded-2xl flex items-center justify-center text-[#A3E635] shadow-lg"><Code size={18} /></div>
