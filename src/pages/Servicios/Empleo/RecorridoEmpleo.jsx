...
const PROJECTS = [
  {
    num: '01',
    category: 'CV & ATS',
    firstPart: 'Currículum',
    highlightPart: 'Optimizado ATS',
    desc: 'Estructuración de perfiles técnicos destacando certificaciones DevOps, Scrum o experiencia médica/administrativa para superar filtros automatizados.',
  ...
  },
  {
    ...
    desc: 'Configuración de titulares, extractos con palabras clave y networking estratégico para atraer a reclutadores IT y corporativos.',
  ...
  },
  {
    ...
    category: 'REDACCIÓN',
    firstPart: 'Cartas y',
    highlightPart: 'Traducción',
    desc: 'Redacción persuasiva de Cover Letters adaptadas a vacantes específicas y traducción técnica al inglés de todo tu perfil.',
    tags: ['Cover Letter', 'Traducción', 'Inglés'],
    icon: 'fa-language',
    images: [
  ...
  },
  {
    ...
    desc: 'Compilación visual de proyectos de código (GitHub), diseños (Figma) o investigaciones académicas en una página web propia.',
  ...
  },
  {
    ...
    highlightPart: 'Asesoría',
    desc: 'Preparación y simulaciones de entrevistas con enfoque en recursos humanos, preguntas técnicas, métricas y seguridad personal.',
  ...
  },
  {
    ...
    highlightPart: 'Digitales',
    desc: 'Diseño y validación visual de diplomas, constancias de cursos y participaciones en eventos y voluntariados.',
              ...
              >
                ...
                <div className="w-full lg:w-1/2 text-center flex flex-col items-center justify-center gap-5">
                  ...
                  <div className="flex items-center justify-between gap-5 w-full pb-4.5 border-b border-slate-100 dark:border-neutral-800 text-left">
                    {/* Columna Izquierda: NÃºmero & Icono */}
                    ...
                    {/* Columna Derecha: TÃ­tulo, Datos y BotÃ³n Ver Detalles */}
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between flex-1 gap-3 sm:gap-6 pl-4 border-l border-slate-150 dark:border-neutral-800 text-left">
                      <div className="flex flex-col">
                        ...
                        <span className="text-[10px] font-bold text-slate-400 dark:text-slate-500 mt-1 uppercase tracking-wider">
                          {p.tags.length} TecnologÃ­as Implementadas
                        </span>
                      </div>
                      
                      <a
                        href={`https://wa.me/59161320004?text=Hola,%20quisiera%20mÃ¡s%20detalles%20sobre%20el%20desarrollo%20de%20un%20proyecto%20tipo%20${encodeURIComponent(p.category)}`}
                        target="_blank"
