        ...
        <div className="relative">
            <section className="relative z-10 py-10">
                ...
                <div className="container mx-auto px-6 max-w-7xl relative z-20">
                    <div className={`bg-gradient-to-br ${gradiente} rounded-[2.5rem] p-8 sm:p-10 text-center shadow-2xl shadow-[#5D3A1F]/30 relative overflow-hidden`}>
                        ...
                        <div className="relative z-10">
                            ...
                            <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/10 border border-white/20 text-[9px] font-black uppercase tracking-widest text-amber-300 mb-3">
                                <i className="fas fa-bolt text-[10px]"></i> Atención inmediata
                            </span>
                            ...
                            {badges.length > 0 && (
                                <div className="flex flex-wrap justify-center gap-2 mb-5">
                                    {badges.map((b, i) => (
                                        <span key={i} className={`inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full ${b.color || 'bg-[#FF4D00]'} text-white text-[9px] font-black uppercase tracking-wider shadow-md hover:-translate-y-0.5 transition-transform`}>
                            ...
                            <div className="flex flex-wrap justify-center gap-3 mb-6">
                                ...
                                <a href="tel:+59161320004" className="inline-flex items-center gap-2.5 px-7 py-3.5 bg-[#FF4D00] hover:bg-[#CC3D00] text-white rounded-full font-black text-xs uppercase tracking-[0.15em] shadow-xl hover:shadow-2xl hover:-translate-y-1 active:scale-95 transition-all">
                                    <i className="fas fa-phone text-base"></i> Llamar
                                </a>
                            </div>
