...
const PROJECTS = [
  ...
  { num: '05', title: 'Paso 5: Entregamos y Mantenemos', desc: 'Desplegamos el sistema en entornos de producción seguros, aplicamos prácticas DevOps y te aseguramos mantenimiento continuo.', tags: ['DevOps', 'Producción', 'Mantenimiento'], icon: 'fa-rocket', images: ['https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&w=800&q=80', 'https://images.unsplash.com/photo-1555774698-0b77e0d5fac6?auto=format&fit=crop&w=800&q=80', 'https://images.unsplash.com/photo-1573164713988-8665fc963095?auto=format&fit=crop&w=800&q=80'] }
];
