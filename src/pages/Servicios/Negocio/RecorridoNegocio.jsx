...
const PROJECTS = [
  ...
  { num: '05', title: 'Paso 5: Entregamos Listo para Vender', desc: 'Te entregamos todos los archivos en alta calidad (con fondos transparentes) y lanzamos tus campañas comerciales con resultados garantizados.', tags: ['Archivos HD', 'Lanzamiento', 'Ventas'], icon: 'fa-shopping-bag', images: ['https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&w=800&q=80', 'https://images.unsplash.com/photo-1555774698-0b77e0d5fac6?auto=format&fit=crop&w=800&q=80', 'https://images.unsplash.com/photo-1573164713988-8665fc963095?auto=format&fit=crop&w=800&q=80'] }
];
