...
const BRANDS = [
  {"name":"Marca y Branding","tag":"Identidad para nuevos negocios","icon":"fa-lightbulb"},
  {"name":"Manual de Identidad","tag":"Paletas, tipografías y reglas","icon":"fa-book-open-reader"},
  {"name":"Menús QR y Catálogos","tag":"Digitalización para vender","icon":"fa-qrcode"},
  {"name":"Campañas y Ofertas","tag":"Promociones, 2x1 y fechas","icon":"fa-bullhorn"},
  {"name":"WhatsApp Business","tag":"Gestión de clientes inicial","icon":"fa-users-gear"}
];

const PROCESO = [
  {"title":"Diagnóstico","desc":"Analizamos tu propuesta, público y mercado para definir la estrategia de marca y de venta."},
  {"title":"Identidad","desc":"Creamos branding, manual de identidad y catálogo inicial alineado a tu negocio."},
  {"title":"Publicidad","desc":"Diseñamos campañas de promociones, ofertas y fechas especiales listas para publicar."},
  {"title":"Lanzamiento","desc":"Configuramos menús QR, WhatsApp Business y las herramientas para vender desde el día uno."}
];
...
const VALUE_POINTS = [
  {"icon":"fa-lightbulb","label":"Identidad Rápida"},
  {"icon":"fa-qrcode","label":"Catálogos QR"},
  {"icon":"fa-bullhorn","label":"Campañas Listas"},
  {"icon":"fa-message","label":"WhatsApp Configurado"}
];
        ...
        <div className="container mx-auto px-6 max-w-7xl relative z-10 flex flex-col items-center">
          ...
          <div className="flex items-center gap-2 mb-5">
              <span className="inline-flex items-center px-4 py-1.5 rounded-full border border-[#A3E635]/45 bg-[#A3E635]/10 text-[9.5px] font-black uppercase tracking-widest text-[#A3E635] shadow-sm leading-none">
                  <i className="fa-solid fa-laptop-code mr-1.5"></i> Para tu Negocio — HagamosTech
              </span>
          </div>
...
<span className="block whitespace-nowrap">arrancá con. <span className="text-[#A3E635] relative inline-block z-10">identidad y ventas.<svg className="absolute w-full h-4 -bottom-2 left-0 z-[-1] text-[#84CC16]" viewBox="0 0 200 9" fill="none"><path d="M2.00025 6.99997C25.7509 4.50435 65.2536 2.07897 197.994 4.4151" stroke="currentColor" strokeWidth="6" strokeLinecap="round" strokeLinejoin="round"/></svg></span></span>
</h1>

              <p className="text-base sm:text-lg font-bold text-slate-300 dark:text-slate-300 leading-relaxed max-w-xl text-center">
                Herramientas para quienes inician proyectos comerciales: estructura, identidad y herramientas de venta inmediata, desde el mercado local hasta modelos de economía circular.
              </p>

              {/* Action Buttons */}
              <div className="flex flex-col sm:flex-row gap-4 mt-2 w-full sm:w-auto items-center justify-center">
                <a
                  href="https://wa.me/59161320004?text=Hola,%20quisiera%20cotizar%20el%20servicio%20para%20mi%20negocio"
                  target="_blank"
                ...
                <a
                  href="https://wa.me/59161320004?text=Hola,%20quisiera%20asesoría%20para%20mi%20emprendimiento"
                  target="_blank"
                  rel="noopener noreferrer"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-6 text-center flex flex-col items-center justify-center">
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-white dark:text-white uppercase leading-tight mb-6 tracking-tighter">
                ¿QUÉ ES EL SERVICIO PARA EMPRENDEDORES Y CÓMO IMPULSA TU NEGOCIO?
              </h2>
...
<p>
Tu nuevo negocio merece arrancar con estructura, identidad y canales de venta funcionales. Te ayudamos a crear tu marca, digitalizar tu oferta y lanzar campañas que vendan desde el primer día.
</p>
<p>
<span className="font-black uppercase tracking-widest text-[#A3E635] dark:text-[#A3E635]">Servicios Específicos: </span>
Creación de Marca y Branding Básico, Manual de Identidad Visual, Menús QR y Catálogos de Productos, Publicidad para Promociones y Ofertas, Publicidad para Fechas Especiales, y Gestión de Clientes Inicial con WhatsApp Business.
</p>
</div>
            </div>
              ...
              <div className="bg-[#1e1e1e] rounded-3xl shadow-2xl border border-neutral-800 overflow-hidden text-left relative group">
                ...
                <div className="bg-[#252526] p-3 flex items-center justify-between border-b border-neutral-900">
                  <div className="flex items-center gap-1.5">
                    ...
                    <span className="text-[10px] text-slate-400 font-bold ml-2 font-mono">negocio.js</span>
                  </div>
                ...
                <div className="p-5 font-mono text-[10.5px] sm:text-[11.5px] leading-relaxed text-slate-300 overflow-x-auto select-none space-y-1">
                  ...
                  <div className="mt-2">export const Negocio = () =&gt; &#123;</div>
                  <div className="pl-4">return (</div>
                  <div className="pl-8">&lt;div className="corporate-layout"&gt;</div>
                  <div className="pl-12">&lt;MetaTags title="HagamosTech — Para tu Negocio" /&gt;</div>
