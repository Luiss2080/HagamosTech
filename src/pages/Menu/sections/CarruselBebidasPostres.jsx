...
const PRODUCTOS_BEBIDAS_POSTRES = [
  ...
  { id: 'ref-6', name: 'Tostada de la Casa', subtitle: 'Nuestro Refresco', icon: 'fa-beer-mug', type: 'Gasificada', desc: 'El refresco oficial de Los Castores. El maridaje perfecto para las picantes.', price: 'Bs. 7', coverImg: '/img/05_Productos/Refrescos/Tostada.png', includes: ['Refresco Tostada', 'Hielo'] },
  ...
  { id: 'com-1', name: 'Combo Desayuno Castorense', subtitle: 'Arranque Perfecto', icon: 'fa-sun', type: 'Promo', desc: 'Salteña + café + jugo. El desayuno completo para arrancar el día con toda la energía.', price: 'Bs. 18', coverImg: '/img/05_Productos/Combos/Desayuno.png', includes: ['1 Salteña', 'Café Americano', 'Jugo natural'] },
                ...
                <div className="w-full px-2 sm:px-4 relative z-20">
                    <div className="text-center mb-2 relative z-10">
                        ...
                        <p className="text-[#1F2937] font-medium max-w-2xl mx-auto text-base sm:text-lg leading-relaxed">
                            Licuados naturales, postres helados y los combos preferidos. Todo para completar tu experiencia castorense.
                        </p>
                    </div>
