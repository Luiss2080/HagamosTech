...
const VideosSucursalesORU = () => {
    ...
    const handleVideoSelection = (newOrder, newCenterId) => {
        ...
        newOrder.forEach((video) => {
            const iframe = document.getElementById(`tiktok-oru-${video.id}`);
    ...
    const handleIframeLoad = () => {
        const iframe = document.getElementById("tiktok-modal-oru-iframe");
        if (iframe && iframe.contentWindow) {
            iframe.contentWindow.postMessage({ "x-tiktok-player": true, "type": "unMute" }, '*');
        }
    };
    ...
    return (
        <div className="relative">
                ...
                <div className="w-full px-4 md:px-8 relative z-20">
                    <div className="text-center mb-4">
                        <span className="inline-block py-1.5 px-4 rounded-full bg-[#8B4513]/10 text-[#8B4513] text-[10px] font-black tracking-widest uppercase mb-4 border border-[#8B4513]/20">
                            <i className="fab fa-tiktok text-[#8B4513] mr-1"></i> TikTok Oruro
                        </span>
                        ...
                        <p className="text-[#1F2937] font-medium max-w-2xl mx-auto text-base sm:text-lg leading-relaxed">
                            Recorré nuestras sucursales en Oruro a través de videos exclusivos y sentí el ambiente único de cada espacio.
                        </p>
                    </div>
                                ...
                                <div
                                    ...
                                    onClick={() => {
                                        if (index !== 2) {
                                            ...
                                            const activeIframe = document.getElementById(`tiktok-oru-${video.id}`);
                                ...
                                >
                                    ...
                                    >
                                        <div className={isActive && lastSelectedId === video.id ? 'animate-spin-lr' : ''} style={{ transformStyle: 'preserve-3d' }}>
                                            <div className={`w-full bg-white rounded-[2.5rem] p-[5px] shadow-2xl transition-all duration-300 ${isActive ? 'ring-[3px] ring-[#8B4513]/50 ring-offset-4 ring-offset-white cursor-pointer hover:ring-[#8B4513]/70' : 'border-2 border-gray-100 hover:border-[#8B4513]/40 hover:shadow-[#8B4513]/20'}`}>
                                                <div className="aspect-[9/16] w-full rounded-[2.2rem] overflow-hidden relative shadow-inner flex items-center justify-center border border-white/10">
                                                    ...
                                                    <div className="absolute left-4 top-4 z-30 bg-[#8B4513] text-white px-3 py-1 rounded-full text-[9px] font-black uppercase tracking-wider shadow-md flex items-center gap-2 border border-white/20">
                                                    ...
                                                    <div className="absolute left-4 bottom-4 z-30 right-4 flex items-end justify-between">
                                                        ...
                                                        <div className="w-8 h-8 rounded-full bg-[#6B3410]/90 text-white flex items-center justify-center border border-white/10 shadow-md">
                                                ...
                                                <div className="mt-4 px-2 pb-1">
                                                    <div className="flex items-center justify-between gap-2 mb-2">
                                                        <span className="inline-flex items-center gap-2 rounded-full bg-[#8B4513]/10 text-[#8B4513] px-3 py-1 text-[10px] font-black uppercase tracking-widest border border-[#8B4513]/20">
            ...
            {modalVideo && (
                <div id="videoModalORU" className="tyr-modal fixed inset-0 z-[200]" aria-modal="true">
                        ...
                        <div className="flex min-h-screen items-center justify-center p-4 text-center sm:p-0" onClick={(e) => { if (e.target === e.currentTarget) setModalVideo(null); }}>
                            <div className="relative w-full max-w-5xl max-h-[92vh] overflow-y-auto scrollbar-none transform overflow-hidden rounded-[2.5rem] bg-white text-left shadow-2xl transition-all sm:my-4 animate-modal-pop border border-gray-200">
                                ...
                                <div className="grid grid-cols-1 lg:grid-cols-2 overflow-hidden">
                                    <div className="relative hidden lg:flex flex-col justify-center gap-6 p-6 lg:p-8 overflow-hidden bg-gradient-to-br from-[#8B4513] to-[#5D3010]">
                                        <div className="absolute inset-0 z-0 pointer-events-none">
                                            <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-[#FF4D00]/15 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2"></div>
                                        ...
                                        <div className="relative z-10 flex flex-col items-center text-center">
                                            ...
                                            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/20 border border-white/30 text-white text-[10px] font-black uppercase tracking-widest mb-6 shadow-lg backdrop-blur-sm">
                                                <span className="w-2 h-2 rounded-full bg-white animate-ping"></span> Sucursales ORU
                                            </div>
                                    ...
                                    <div className="relative flex flex-col items-center justify-center bg-[#FFF6F6] p-8 min-h-[480px] sm:min-h-[540px]">
                                        <div className="absolute inset-0 overflow-hidden pointer-events-none">
                                            <div className="absolute -top-10 -right-10 w-64 h-64 bg-[#8B4513]/10 rounded-full blur-3xl"></div>
                                            <div className="absolute top-1/2 -left-10 w-40 h-40 bg-[#8B4513]/20 rounded-full blur-2xl"></div>
                                            <div className="absolute bottom-0 right-10 w-56 h-56 bg-[#8B4513]/10 rounded-full blur-3xl"></div>
...
export default VideosSucursalesORU;
