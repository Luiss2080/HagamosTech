...
const SUCURSALES = [
  ...
  { id: 'scz-2', slug: '2do-anillo', name: 'HagamosTech 2do Anillo', badge: 'SCZ 02', address: '6R59+5W7', phone: '3 3391432', schedule: 'Abierto hasta la 1:30 p.m.', services: ['Consumo', 'Llevar', 'Delivery', 'WiFi', 'Familiar', 'Bebidas'], mapLink: 'https://maps.app.goo.gl/GYF5RyA9vtDnDJ9WA', img: '/img/10_sucursales/SantaCruz/02_Sucursal.png', desc: 'Punto estratégico sobre la vía más transitada. Amplio espacio interior, ideal para grupos y familias.' },
  { id: 'scz-3', slug: 'av-pirai', name: 'Salteñas HagamosTech Av. Piraí', badge: 'SCZ 03', address: 'Av. Piraí 344', phone: '3 3552038', schedule: '7:45 a.m. – 1:00 p.m.', services: ['Consumo', 'Llevar', 'Delivery', 'WiFi', 'Rápido', 'Jugos'], mapLink: 'https://maps.app.goo.gl/vyDVunvkBmjqjKbf7', img: '/img/10_sucursales/SantaCruz/03_Sucursal.png', desc: 'La sucursal de los madrugadores. Abre temprano para que arranques el día con la mejor salteña.' },
  { id: 'scz-4', slug: 'cafe-beni', name: 'HagamosTech Café Beni', badge: 'SCZ 04', address: 'Av. Beni 2160', phone: '+591 61320004', schedule: '7:00 a.m. – 2:00 p.m.', services: ['Consumo', 'Cafetería', 'Llevar', 'Delivery', 'Terraza', 'Pastelería'], mapLink: 'https://maps.app.goo.gl/wwNLzMyyizWoJXBGA', img: '/img/10_sucursales/SantaCruz/04_Sucursal.png', desc: 'Experiencia gourmet. Salteñas artesanales acompañadas de café de especialidad en una terraza acogedora.' }
];
