                ...
                <div className="grid w-full gap-6 lg:grid-cols-[1.05fr_1.35fr]">
                        ...
                        <div className="relative z-10 flex h-full flex-col justify-between gap-4">
                            <div>
                                ...
                                <p className="mt-4 max-w-xl text-sm leading-6 text-blue-50 sm:text-base">
                                    Consulta las reglas de contratación, entrega, garantía y uso de HagamosTech en una página clara, compacta y pensada para clientes.
                                </p>
                            </div>
                    ...
                    <section className="relative overflow-hidden rounded-[2rem] border border-[#dbe8fb] bg-white p-5 shadow-xl sm:p-6 lg:p-8">
                        ...
                        <div className="flex flex-col gap-4 border-b border-[#edf2fb] pb-5 sm:flex-row sm:items-end sm:justify-between">
                            <div>
                                <span className="inline-flex items-center gap-2 rounded-full bg-[#fef2f2] px-3 py-1 text-[10px] font-black uppercase tracking-[0.22em] text-[#A3E635] ring-1 ring-[#fca5a5]">
...
HagamosTech
                        ...
                        <div className="mt-5 rounded-2xl border border-[#dbe8fb] bg-[#fff5f5] p-4 text-sm leading-6 text-[#2b4566]">
                            <div className="flex items-start gap-3">
                                <span className="mt-0.5 flex h-8 w-8 shrink-0 items-center justify-center rounded-xl bg-[#fef2f2] text-[#A3E635] ring-1 ring-[#fca5a5]">
                        ...
                        <div className="mt-4 flex flex-wrap gap-3">
                            <a href="/" className="inline-flex items-center gap-2 rounded-2xl border border-[#dbe8fb] bg-white px-4 py-2.5 text-xs font-black uppercase tracking-[0.16em] text-[#0d1b3e] transition hover:border-[#A3E635] hover:text-[#A3E635]">
                                <i className="fas fa-house"></i>
                                Volver al inicio
                            </a>
                            <a href="/contactanos" className="inline-flex items-center gap-2 rounded-2xl border border-[#dbe8fb] bg-white px-4 py-2.5 text-xs font-black uppercase tracking-[0.16em] text-[#0d1b3e] transition hover:border-[#A3E635] hover:text-[#A3E635]">
