            ...
            <section className="relative z-10 py-4">
                ...
                <div className="container mx-auto px-6 max-w-7xl relative z-20">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {USOS.map((uso, i) => (
                            <div key={i} className="relative bg-[#111827] rounded-[2rem] border border-white/10 shadow-md overflow-hidden group hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                                ...
                                <div className="relative z-10 p-6">
                                    <div className="flex items-start gap-4 mb-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs text-slate-300 font-semibold mt-1 leading-relaxed">{uso.desc}</p>
                                        </div>
                                    </div>
                                    <div className="pt-4 border-t border-dashed border-white/10 flex flex-wrap gap-1.5">
