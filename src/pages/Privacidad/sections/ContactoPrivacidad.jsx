        ...
        <div className="relative">
            <section className="relative z-10 py-10">
                ...
                <div className="container mx-auto px-6 max-w-7xl relative z-20">
                    <div className="bg-gradient-to-br from-[#8B4513] via-[#5D3A1F] to-[#452A16] rounded-[2.5rem] p-8 sm:p-10 shadow-2xl shadow-[#5D3A1F]/30 relative overflow-hidden">
                        ...
                        <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                            <div>
                                <span className="inline-block bg-white/10 text-[#FFE8D6] px-4 py-1.5 rounded-full text-[10px] font-black tracking-[0.2em] uppercase border border-white/15 mb-5">
                                    <i className="fas fa-headset mr-1.5 text-[#FF4D00]"></i> DPO / Delegado de Datos
                                </span>
