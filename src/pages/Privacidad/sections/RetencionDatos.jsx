...
const RETENCION = [
    ...
    { icon: 'fa-envelope', titulo: 'Comunicaciones', detalle: 'Emails y WhatsApp', duracion: '2 años', dias: 50, color: 'from-[#171717] to-[#171717]', nota: 'Se purgan automáticamente.', items: ['Emails', 'Chats', 'Alertas'] },
            ...
            <section className="relative z-10 py-4">
                ...
                <div className="container mx-auto px-6 max-w-7xl relative z-20">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 items-stretch">
                                ...
                                return (
                                    <button
                                        ...
                                        className={`relative flex items-center gap-3 p-3.5 rounded-2xl text-left transition-all duration-300 ${
                                            isActive ? 'bg-[#111827] shadow-lg shadow-orange-950/10 ring-2 ring-[#A3E635]/40 scale-[1.01]' : 'bg-white/60 border border-orange-50 hover:bg-[#111827] hover:shadow-md'
                                        }`}
                                    >
                        ...
                        {/* Detalle (7 cols) */}
                        <div className="lg:col-span-7 bg-[#111827] rounded-[2rem] ring-1 ring-orange-100 shadow-xl shadow-orange-950/5 relative overflow-hidden flex flex-col">
                            ...
                            <div className="relative z-10 p-6 sm:p-8 flex flex-col flex-1">
                                <div className="flex items-center gap-4 mb-5 pb-4 border-b border-dashed border-white/10">
                                ...
                                <div className="mb-5">
                                    ...
                                    <div className="h-4 rounded-full bg-white/5 overflow-hidden border border-orange-50">
                                ...
                                <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 mb-4">
                                    {actual.items.map((item, j) => (
                                        <span key={j} className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-[#FFFFFF] border border-white/10 text-[#171717] text-[10px] font-black uppercase tracking-wider">
                                            <i className="fas fa-circle-check text-[#A3E635] text-[9px]"></i>{item}
                                        </span>
                                    ))}
                                </div>

                                <div className="mt-auto flex items-start gap-3 p-4 rounded-2xl bg-[#FFFFFF] border border-white/10">
                                    <div className="w-8 h-8 rounded-lg bg-[#111827] border border-white/10 text-[#A3E635] flex items-center justify-center shrink-0 shadow-sm">
