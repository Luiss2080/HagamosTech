...
const LOGROS = [
    ...
    { year: '2022', icon: 'fa-graduation-cap', titulo: 'Acompañamiento académico', desc: 'Acompañamos a más de 300 estudiantes en sus proyectos de desarrollo web, lógica y uso de IA.', color: 'bg-[#8B4513]', soft: 'bg-[#8B4513]/10 text-[#8B4513] border-[#8B4513]/25', badge: 'bg-[#8B4513]', feats: [{ icon: 'fa-user-graduate', label: '300+ estudiantes', chip: 'bg-[#8B4513]/10 text-[#8B4513] border-[#8B4513]/25' }, { icon: 'fa-diagram-project', label: 'Proyectos', chip: 'bg-orange-50 text-[#8B4513] border-orange-100' }] },
