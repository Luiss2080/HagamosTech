...
const LOGROS = [
    { year: '2026', icon: 'fa-trophy', titulo: 'Reconocimiento a la innovación', desc: 'Premiados a nivel regional por nuestros proyectos de IA y automatización para pymes.', color: 'bg-[#FF4D00]', soft: 'bg-[#FF4D00]/10 text-[#FF4D00] border-[#FF4D00]/25', badge: 'bg-[#FF4D00]', feats: [{ icon: 'fa-award', label: 'Premio regional', chip: 'bg-[#FF4D00]/10 text-[#FF4D00] border-[#FF4D00]/25' }, { icon: 'fa-users', label: 'Votación del sector', chip: 'bg-orange-50 text-[#8B4513] border-orange-100' }] },
    { year: '2024', icon: 'fa-rocket', titulo: '+120 proyectos entregados', desc: 'Cinco años construyendo soluciones web, sistemas y automatizaciones para clientes de toda Bolivia.', color: 'bg-[#5D3A1F]', soft: 'bg-[#5D3A1F]/10 text-[#5D3A1F] border-[#5D3A1F]/25', badge: 'bg-[#5D3A1F]', feats: [{ icon: 'fa-diagram-project', label: '120+ proyectos', chip: 'bg-[#5D3A1F]/10 text-[#5D3A1F] border-[#5D3A1F]/25' }, { icon: 'fa-calendar', label: '5 años', chip: 'bg-orange-50 text-[#8B4513] border-orange-100' }] },
    { year: '2022', icon: 'fa-graduation-cap', titulo: 'Programa de formación', desc: 'Capacitamos a más de 300 estudiantes en desarrollo web, lógica de programación y uso de IA.', color: 'bg-[#8B4513]', soft: 'bg-[#8B4513]/10 text-[#8B4513] border-[#8B4513]/25', badge: 'bg-[#8B4513]', feats: [{ icon: 'fa-user-graduate', label: '300+ estudiantes', chip: 'bg-[#8B4513]/10 text-[#8B4513] border-[#8B4513]/25' }, { icon: 'fa-chalkboard-user', label: 'Talleres', chip: 'bg-orange-50 text-[#8B4513] border-orange-100' }] },
    { year: '2020', icon: 'fa-certificate', titulo: 'Nace HagamosTech', desc: 'Arrancamos con una idea simple: resolver necesidades reales con tecnología, sin vueltas.', color: 'bg-[#CC3D00]', soft: 'bg-[#CC3D00]/10 text-[#CC3D00] border-[#CC3D00]/25', badge: 'bg-[#CC3D00]', feats: [{ icon: 'fa-seedling', label: 'Fundación', chip: 'bg-[#CC3D00]/10 text-[#CC3D00] border-[#CC3D00]/25' }, { icon: 'fa-handshake', label: 'Primeros clientes', chip: 'bg-orange-50 text-[#8B4513] border-orange-100' }] },
];
