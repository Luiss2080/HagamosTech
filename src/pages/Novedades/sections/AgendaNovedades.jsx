...
const TIPO_INFO = {
    ...
    aniv: { label: 'Aniversario', bg: 'bg-[#0A0A0A]', text: 'text-white', soft: 'bg-[#0A0A0A]/10 border-[#0A0A0A]/25', gradient: 'from-[#0A0A0A] to-[#171717]', ring: 'ring-[#0A0A0A]/40', glow: 'shadow-[0_6px_20px_rgba(139,69,19,0.25)]' },
};
