...
const ACHIEVEMENTS = [
    { id: 'ach-1', name: 'Líder Frontend', desc: 'Completó los módulos 1 y 2 de Desarrollo Web', icon: 'fa-microchip', color: 'text-lime-300 bg-amber-400/10 border-amber-400/30' },
...
const ProfileSidebar = ({ formData, handleChange, preferences, handleTogglePref, isSavingPrefs, handleSavePreferences }) => {
    ...
    return (
        <div className="relative hidden lg:flex flex-col justify-start p-6 overflow-hidden bg-gradient-to-br from-[#0A0A0A] via-[#A3E635] to-[#0A0A0A] w-full h-full rounded-[2.5rem] shadow-xl">
            ...
            <div className="relative z-10 flex flex-col items-center w-full space-y-4">
                ...
                <div className="w-full pb-3.5 border-b border-white/10 text-left">
                    <h1 className="text-xs font-black uppercase tracking-wider text-white flex items-center gap-1.5">
                        <i className="fas fa-microchip text-lime-300"></i> HagamosTech
                    </h1>
                ...
                <div className="flex flex-col items-center text-center w-full px-1">
                    <div className="mb-2 inline-flex items-center justify-center rounded-[2rem] bg-white/20 p-2 shadow-2xl ring-1 ring-white/35 backdrop-blur-md">
                        <div className="flex h-16 w-16 items-center justify-center rounded-[1.2rem] bg-[#111827] text-[#A3E635] text-xl font-black shadow-lg overflow-hidden border-2 border-white/50">
                            {userAvatar ? (
                    ...
                    {navItems.map((item) => {
                        ...
                        return (
                            <Link 
                                key={item.path}
                                to={item.path} 
                                className={`flex items-center gap-3 rounded-xl border px-3 py-2 text-left transition-all duration-200 ${isActive ? 'border-transparent bg-[#111827] shadow-md scale-[1.01]' : 'border-white/10 bg-white/5 hover:bg-white/10 hover:border-white/20'}`}
                            >
                                <div className={`w-7 h-7 rounded-lg flex items-center justify-center shrink-0 ${isActive ? 'bg-white/5 text-[#A3E635]' : 'bg-white/10 text-white'}`}>
                ...
                <div className="w-full bg-black/15 border border-white/5 rounded-2xl p-3.5 text-left shadow-inner">
                    <div className="flex items-center justify-between mb-1.5">
                        <span className="text-[8px] font-black uppercase tracking-widest text-[#A3E635] flex items-center gap-1">
                            <i className="fas fa-crown text-lime-300 text-[9px]"></i> Club HagamosTech
                        </span>
                    ...
                    <div className="w-full bg-white/10 h-1.5 rounded-full overflow-hidden mb-1">
                        <div className="h-full bg-gradient-to-r from-amber-400 to-[#A3E635] rounded-full" style={{ width: '81%' }} />
                    </div>
                ...
                <div className="w-full bg-black/15 border border-white/5 rounded-2xl p-3.5 text-left shadow-inner">
                    <h3 className="text-[8px] font-black uppercase tracking-widest text-red-200 mb-2 flex items-center gap-1">
                        <i className="fas fa-award text-xs text-lime-300"></i> Logros Académicos
                    </h3>
                ...
                <div className="w-full bg-black/15 border border-white/5 rounded-2xl p-3 text-left shadow-inner">
                    <div className="flex items-center gap-2 mb-2.5">
                        <div className="w-6 h-6 rounded-lg bg-[#A3E635] text-[#0A0A0A] flex items-center justify-center text-[9px] shadow-md shrink-0">
                            <i className="fas fa-bell"></i>
                        </div>
                        <div>
                            <h4 className="text-[8px] font-black text-lime-300 uppercase tracking-wider m-0 leading-tight">Preferencias de Alertas</h4>
                        ...
                        {[
                            ...
                            <div key={item.key} className="flex items-center justify-between gap-2">
                                <div className="flex items-center gap-2">
                                    <div className="w-5 h-5 rounded flex items-center justify-center bg-white/10 text-lime-300/80">
                                ...
                                <button 
                                    ...
                                    className={`relative inline-flex h-5 w-9 shrink-0 cursor-pointer rounded-full border border-transparent transition-colors duration-200 focus:outline-none ${preferences[item.key] ? 'bg-[#A3E635]' : 'bg-white/20'}`}
                                >
                                    <span className={`pointer-events-none inline-block h-4 w-4 transform rounded-full bg-[#111827] shadow transition duration-200 ${preferences[item.key] ? 'translate-x-[18px]' : 'translate-x-[1px]'}`} />
                                </button>
                            </div>
                        ))}
                    </div>
                    <button 
                        ...
                        className="w-full mt-2 py-1.5 rounded-lg bg-[#A3E635] hover:bg-red-800 text-[#0A0A0A] text-[7px] font-black uppercase tracking-widest transition-all cursor-pointer border-0 disabled:opacity-50"
                    >
                ...
                <div className="w-full bg-black/15 border border-white/5 rounded-2xl p-3 text-left shadow-inner">
                    <div className="flex items-center gap-2 mb-2.5">
                        ...
                        <div>
                            <h4 className="text-[8px] font-black text-lime-300 uppercase tracking-wider m-0 leading-tight">Redes Sociales y Enlaces</h4>
                            <p className="text-[6px] text-white/40 font-bold uppercase tracking-widest m-0">Perfiles profesionales y contacto</p>
                        </div>
                    </div>
                    <div className="flex flex-col gap-2">
                        <div>
                            <label className="block text-[7px] font-black uppercase tracking-wider text-lime-300/80 mb-0.5">LinkedIn</label>
                        ...
                        <div>
                            <label className="block text-[7px] font-black uppercase tracking-wider text-lime-300/80 mb-0.5">GitHub</label>
                            <div className="relative">
                        ...
                        <div>
                            <label className="block text-[7px] font-black uppercase tracking-wider text-lime-300/80 mb-0.5">Facebook</label>
                            <div className="relative">
                ...
                <div className="w-full pt-1.5 border-t border-white/10">
                    <button 
                        ...
                        className="w-full py-3.5 bg-[#111827] hover:bg-white/5 text-[#A3E635] text-[10px] font-black uppercase tracking-widest shadow-lg transition-all hover:scale-[1.02] active:scale-95 cursor-pointer flex items-center justify-center gap-2 rounded-full border-0"
                    >
            ...
            {selectedAch && (
                <div className="fixed inset-0 z-[300] flex items-center justify-center p-4">
                    ...
                    <div className="relative w-full max-w-xs transform overflow-hidden rounded-[2rem] bg-[#111827] p-6 text-center shadow-2xl border-2 border-[#A3E635] animate-modal-pop">
                        <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-2xl bg-lime-400/15 text-lime-400 text-2xl mb-4">
                            <i className="fas fa-award"></i>
                        </div>
                        <h4 className="text-sm font-black text-slate-850 uppercase tracking-wider mb-1">{selectedAch.name}</h4>
                        <p className="text-xs text-slate-400 mb-5 leading-relaxed">{selectedAch.desc}</p>
                        <button 
                            onClick={() => setSelectedAch(null)}
                            className="w-full py-2.5 bg-[#A3E635] hover:bg-[#0A0A0A] text-[#0A0A0A] font-black text-[10px] uppercase tracking-widest rounded-xl transition active:scale-95 cursor-pointer"
                        >
                            Aceptar
                        </button>
                    </div>
            ...
            {showDiploma && (
                <div className="fixed inset-0 z-[300] flex items-center justify-center p-4">
                    ...
                    <div className="relative w-full max-w-xl transform overflow-hidden rounded-[2.5rem] bg-[#111827] p-8 text-center shadow-2xl border border-white/10 animate-modal-pop">
                        <button
                            onClick={() => setShowDiploma(false)}
                            className="absolute top-6 right-6 w-8 h-8 flex items-center justify-center rounded-full bg-white/5 text-slate-400 hover:text-red-500 hover:bg-white/5 dark:hover:bg-red-950/20 transition cursor-pointer"
                        >
                            <i className="fas fa-times"></i>
                        </button>

                        {/* Certificate Mockup Frame */}
                        <div ref={diplomaRef} className="border-8 border-[#A3E635] p-6 rounded-2xl bg-[#111111] text-slate-100 relative overflow-hidden shadow-inner mb-6">
                            <div className="absolute top-0 right-0 w-24 h-24 bg-[#A3E635]/10 rounded-full blur-2xl pointer-events-none" />
                            <div className="absolute bottom-0 left-0 w-32 h-32 bg-[#A3E635]/5 rounded-full blur-3xl pointer-events-none" />
                            
                            <h3 className="font-serif text-[#A3E635] text-xl font-bold italic tracking-wide">HagamosTech</h3>
                            <p className="text-[8px] font-black uppercase tracking-[0.25em] text-[#A3E635] mt-1">Software & Digital Solutions</p>
                            
                            <div className="w-10 h-0.5 bg-slate-350 mx-auto my-3" />
                            
                            <p className="text-[10px] font-bold italic text-slate-400">Este certificado de excelencia es otorgado a:</p>
                            <h4 className="text-lg font-black font-sans text-white mt-1 uppercase tracking-wider">{displayName}</h4>
                            
                            <p className="text-[10px] font-medium leading-relaxed max-w-xs mx-auto mt-3 text-slate-300">
                            ...
                            <div className="flex justify-between items-center mt-6 px-4">
                                ...
                                <div className="w-12 h-12 bg-[#111827] rounded-full flex items-center justify-center border border-[#A3E635]/30 shadow-sm relative">
                                    <i className="fas fa-certificate text-2xl text-[#A3E635]" />
                                    <i className="fas fa-check text-[9px] text-[#A3E635] absolute" />
                                </div>
                                <div className="text-center">
                                    <div className="h-0.5 w-16 bg-slate-300 mx-auto mb-1" />
                        ...
                        <button 
                            ...
                            className="w-full py-3.5 bg-[#A3E635] hover:bg-[#0A0A0A] text-[#0A0A0A] font-black text-xs uppercase tracking-widest rounded-xl shadow-md transition active:scale-95 cursor-pointer"
                        >
