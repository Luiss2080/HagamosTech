...
const HistorialComprasPagina = () => {
    ...
    return (
        <div id="compras-perfil-page" className="relative overflow-hidden min-h-screen bg-[#111827]">
            <CircuitBackground />
            ...
            <PageHero
                title="Mis compras y"
                highlight="pedidos"
                description="Consulta el historial de servicios y soluciones que contrataste, y descarga tus facturas oficiales."
            />
                ...
                <div className="grid grid-cols-1 lg:grid-cols-[340px_1fr] gap-8 items-stretch">
                    ...
                    <div className="flex flex-col gap-8">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                            <div className="flex items-center gap-4 rounded-2xl bg-[#111827] p-5 shadow-xl border border-white/10 border-l-4 border-l-[#A3E635]">
                            ...
                            <div className="flex items-center gap-4 rounded-2xl bg-[#111827] p-5 shadow-xl border border-white/10 border-l-4 border-l-[#A3E635]">
                                <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-white/50/10 text-lime-400 text-lg shadow-inner">
                        ...
                        <div className="bg-[#111827] rounded-2xl p-5 shadow-xl border border-white/10 border-l-4 border-l-[#A3E635]">
                            <div className="bg-gradient-to-r from-red-50/90 via-white to-transparent p-3.5 rounded-xl border border-white/10/70 mb-4 flex items-center gap-3">
                                ...
                                <div>
                                    <h3 className="text-sm font-black text-white uppercase tracking-wider m-0">HISTORIAL DE COMPRAS</h3>
                                    <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest leading-normal m-0 mt-0.5">PEDIDOS Y FACTURAS</p>
                                </div>
                            </div>
                            ...
                            <div className="overflow-x-auto">
                                <table className="w-full text-left border-collapse text-xs">
                                    <thead>
                                        <tr className="border-b-2 border-white/10 text-[#A3E635] uppercase text-[9px] font-black tracking-widest bg-white/5/30">
                                    ...
                                    <tbody className="divide-y divide-slate-100 font-semibold text-slate-100">
                                        {loading ? (
                                                <tr>
                                            ...
                                            <tr key={invoice.id} className="hover:bg-white/5/30 dark:hover:bg-red-950/20 transition-colors">
                                                ...
                                                <td className="py-4 font-bold truncate max-w-[180px]" title={invoice.item}>
                                                    <span className="text-[10px] bg-white/5 text-slate-400 px-2 py-0.5 rounded-md mr-2">{invoice.category}</span>
                                                    {invoice.item}
                                                </td>
            ...
            {selectedInvoice && (
                <div className="fixed inset-0 z-[200] bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 font-montserrat">
                    <div className="bg-[#111827] rounded-2xl p-6 max-w-sm w-full border border-white/10 shadow-2xl relative animate-fade-in">
                        <button
                            onClick={() => setSelectedInvoice(null)}
                            className="absolute top-4 right-4 w-7 h-7 flex items-center justify-center rounded-full bg-white/5 text-slate-400 hover:text-red-500 hover:bg-white/5 dark:hover:bg-red-950/20 transition cursor-pointer text-[10px]"
                        >
                            <i className="fas fa-times"></i>
                        </button>

                        <div className="text-center">
                            <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-xl bg-white/5 text-[#A3E635] text-xl mb-3">
                                <i className="fas fa-file-invoice-dollar"></i>
                            </div>
                            <h3 className="text-sm font-black text-white uppercase tracking-wider mb-1">Factura Digital Oficial</h3>
                        ...
                        <div className="border border-white/10 p-4 rounded-xl bg-[#111111] text-slate-100 text-left text-xs font-semibold space-y-3 shadow-inner mb-4">
                            <div className="flex justify-between border-b border-white/10 pb-3">
                                ...
                                <div className="text-right">
                                    <p className="font-bold text-slate-400 text-[10px] uppercase">FACTURA</p>
                            ...
                            <div className="space-y-1">
                                ...
                                <p className="text-slate-100 font-bold">{userData.nombre} {userData.apellido || ''}</p>
                                <p className="text-[10px] text-slate-400">{userData.correo}</p>
                            </div>

                            <div className="border-t border-b border-white/10 py-2.5 space-y-2">
