...
const ACCENT_COLORS = [
    { name: 'Rojo Robótico', value: '#A3E635', hover: '#0A0A0A', bg: 'bg-[#A3E635]', ring: 'ring-[#A3E635]' },
    ...
    { name: 'Verde Cyber', value: '#A3E635', hover: '#059669', bg: 'bg-[#A3E635]', ring: 'ring-[#A3E635]' },
];
...
const ConfiguracionPagina = () => {
    ...
    return (
        <div id="config-page" className="relative overflow-hidden min-h-screen bg-[#111827]">
            <CircuitBackground />
            ...
            <section className="relative z-10 py-5 max-w-[95rem] mx-auto px-4 sm:px-6">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-[340px_1fr] gap-4 items-stretch">
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <div className="flex lg:hidden gap-2 bg-[#111111] p-2 rounded-2xl border border-white/10 overflow-x-auto scrollbar-none">
                            {navItemsMobile.map((item) => {
                                ...
                                return (
                                    <Link 
                                        key={item.path}
                                        to={item.path}
                                        className={`flex items-center gap-2.5 px-5 py-3 rounded-xl font-black text-xs uppercase tracking-wider transition-all whitespace-nowrap ${isActive ? 'bg-[#A3E635] text-[#0A0A0A] shadow-md' : 'text-slate-400 hover:bg-[#A3E635]/5 dark:hover:bg-white/5'}`}
                                    >
                        ...
                        <div className="bg-[#111827] rounded-2xl p-3 shadow-lg border border-white/10 border-l-4 border-l-[#A3E635]">
                            <div className="bg-gradient-to-r from-red-50/90 via-white to-transparent p-2.5 rounded-xl border border-white/10/70 mb-2.5 flex items-center gap-2.5">
                                ...
                                <div>
                                    <h3 className="text-[11px] font-black text-white uppercase tracking-wider m-0">Personalización Visual</h3>
                                    <p className="text-[8px] text-slate-400 font-bold uppercase tracking-widest leading-normal m-0 mt-0.5">APARIENCIA DEL PORTAL</p>
                                </div>
                            </div>
                                        ...
                                        {ACCENT_COLORS.map((color) => {
                                            ...
                                            return (
                                                <button
                                                    ...
                                                    className={`p-2 rounded-xl border flex items-center gap-2 transition-all cursor-pointer text-left text-[10px] ${isSelected ? `border-[#A3E635] bg-[#A3E635]/5 font-black text-[#A3E635] ring-2 ${color.ring}/25` : 'border-white/10 bg-[#111111] text-slate-200 hover:border-white/10 dark:hover:border-slate-700'}`}
                                                >
                        ...
                        <div className="bg-[#111827] rounded-2xl p-3 shadow-lg border border-white/10 border-l-4 border-l-[#A3E635]">
                            <div className="bg-gradient-to-r from-red-50/90 via-white to-transparent p-2.5 rounded-xl border border-white/10/70 mb-2.5 flex items-center gap-2.5">
                                ...
                                <div>
                                    <h3 className="text-[11px] font-black text-white uppercase tracking-wider m-0">Nivel de Privacidad</h3>
                                    <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest leading-normal m-0 mt-0.5">VISIBILIDAD DEL PERFIL</p>
                                </div>
                            </div>
                                    ...
                                    {PRIVACY_LEVELS.map((level) => {
                                        ...
                                        return (
                                            <button
                                                ...
                                                className={`p-3 rounded-xl border text-left transition-all cursor-pointer flex flex-col justify-between ${isSelected ? 'border-[#A3E635] bg-[#A3E635]/5 font-black shadow-md ring-2 ring-[#A3E635]/15' : 'border-white/10 bg-white/5/50 font-bold text-slate-200 dark:text-slate-300'}`}
                                            >
                        ...
                        <div className="bg-[#111827] rounded-2xl p-3 shadow-lg border border-white/10 border-l-4 border-l-[#A3E635]">
                            <div className="bg-gradient-to-r from-red-50/90 via-white to-transparent p-2.5 rounded-xl border border-white/10/70 mb-2.5 flex items-center gap-2.5">
                                ...
                                <div>
                                    <h3 className="text-[11px] font-black text-white uppercase tracking-wider m-0">Seguridad</h3>
                                    <p className="text-[8px] text-slate-400 font-bold uppercase tracking-widest leading-normal m-0 mt-0.5">PROTECCIÓN DE LA CUENTA</p>
                                </div>
                            </div>

                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                {/* Change Password */}
                                <div className="space-y-2 border-r-0 sm:border-r border-white/10 sm:pr-4">
                                    ...
                                    <form onSubmit={handlePasswordSubmit} className="space-y-2">
                                        <input 
                                            ...
                                            required
                                            className="w-full px-3.5 py-2.5 rounded-xl border border-white/10 bg-white/5 text-slate-100 text-xs focus:ring-2 focus:ring-[#A3E635]/40 outline-none font-bold placeholder:text-slate-400/50"
                                        />
                                        <input 
                                            type="password" 
                                            name="new"
                                ...
                                <div className="space-y-2 flex flex-col justify-between">
                                    <div>
                                        <h4 className="text-[10px] font-black text-slate-850 uppercase tracking-wider flex items-center gap-2">
                                            Doble Factor (2FA) 
                                            <span className={`px-2 py-0.5 rounded-full text-[7px] font-black uppercase tracking-widest ${is2FAEnabled ? 'bg-green-100 text-green-700 dark:text-green-400' : 'bg-lime-400/15 text-amber-700 dark:text-lime-300'}`}>
                                    ...
                                    <div className="bg-[#111111] p-2.5 rounded-xl border border-white/10 flex items-center justify-between gap-2">
                                        <div className="flex gap-2 items-center">
                                            <div className="w-7 h-7 rounded-lg bg-white/5 text-slate-400 flex items-center justify-center text-sm"><i className="fas fa-mobile-screen"></i></div>
                                            <div>
                                                <p className="text-[10px] font-extrabold text-slate-100 leading-tight">Código por Aplicación</p>
                                        ...
                                        <button 
                                            ...
                                            disabled={faLoading}
                                            className={`relative inline-flex h-6.5 w-12 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none disabled:opacity-50 ${is2FAEnabled ? 'bg-[#A3E635]' : 'bg-white/10 dark:bg-slate-800'}`}
                                        >
                                            <span className={`pointer-events-none inline-block h-5.5 w-5.5 transform rounded-full bg-[#111827] shadow ring-0 transition duration-200 ease-in-out ${is2FAEnabled ? 'translate-x-5.5' : 'translate-x-0'}`} />
                                        </button>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            {/* Active Sessions */}
                            <div className="bg-[#111827] rounded-2xl p-3 shadow-lg border border-white/10 border-l-4 border-l-[#A3E635]">
                                <div className="bg-gradient-to-r from-red-50/90 via-white to-transparent p-3.5 rounded-xl border border-white/10/70 mb-4 flex items-center gap-3">
                                    ...
                                    <div>
                                        <h3 className="text-[11px] font-black text-white uppercase tracking-wider m-0">Sesiones Activas</h3>
                                        <p className="text-[8px] text-slate-400 font-bold uppercase tracking-widest leading-normal m-0 mt-0.5">DISPOSITIVOS CONECTADOS</p>
                                    </div>
                                </div>
                                <div className="space-y-2">
                                    {sesiones.length === 0 ? (
                                        ...
                                        sesiones.map((sess) => (
                                            <div key={sess.id} className="flex items-center justify-between border-b border-white/10 pb-2 last:border-0 last:pb-0">
                                                ...
                                                {sess.date !== 'Conectado ahora' && (
                                                    <button 
                                                        ...
                                                        disabled={sesLoading}
                                                        className="text-[8px] font-black uppercase tracking-wider text-red-500 hover:text-[#A3E635] cursor-pointer bg-white/5 px-2 py-1 rounded-lg border border-white/10 transition disabled:opacity-50"
                                                    >
                            ...
                            <div className="bg-[#111827] rounded-2xl p-3 shadow-lg border border-white/10 border-l-4 border-l-[#A3E635] flex flex-col justify-between">
                                <div>
                                    <div className="bg-gradient-to-r from-red-50/90 via-white to-transparent p-3.5 rounded-xl border border-white/10/70 mb-4 flex items-center gap-3">
                                        <div className="w-9 h-9 rounded-xl bg-[#A3E635] text-[#0A0A0A] flex items-center justify-center text-sm shadow-md shadow-red-500/20 shrink-0">
                                        ...
                                        <div>
                                            <h3 className="text-[11px] font-black text-white uppercase tracking-wider m-0">Acciones Avanzadas</h3>
                                            <p className="text-[8px] text-slate-400 font-bold uppercase tracking-widest leading-normal m-0 mt-0.5">GESTIÓN DE DATOS</p>
                                        </div>
                                    </div>
            ...
            {show2FAModal && (
                <div className="fixed inset-0 z-[200] bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 font-montserrat" onClick={() => setShow2FAModal(false)}>
                    <div className="bg-[#111827] rounded-2xl p-6 max-w-sm w-full border border-white/10 shadow-2xl relative animate-fade-in" onClick={(e) => e.stopPropagation()}>
                        <button
                            onClick={() => setShow2FAModal(false)}
                            className="absolute top-4 right-4 w-8 h-8 flex items-center justify-center rounded-full bg-white/5 text-slate-400 hover:text-red-500 hover:bg-white/5 dark:hover:bg-red-950/20 transition cursor-pointer"
                        >
                            <i className="fas fa-times"></i>
                        </button>

                        <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-2xl bg-white/5 text-[#A3E635] text-2xl mb-4 shadow-sm">
                        ...
                        {/* Real QR Code */}
                        <div className="mx-auto w-44 h-44 bg-[#111827] border-2 border-white/10 p-2.5 rounded-2xl flex items-center justify-center mb-3 shadow-md relative group overflow-hidden">
                        ...
                        <form onSubmit={handleConfirm2FA} className="space-y-4">
                            <div>
                                <input 
                                    ...
                                    required
                                    className="w-full text-center text-lg font-black tracking-[0.4em] px-3.5 py-2.5 rounded-xl border border-white/10 bg-white/5 text-slate-100 text-xs focus:ring-2 focus:ring-[#A3E635]/40 outline-none font-bold placeholder:text-slate-400/50"
                                />
                            </div>
                            {codeError && (
            ...
            {showDangerModal && (
                <div className="fixed inset-0 z-[200] bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 font-montserrat" onClick={() => setShowDangerModal(false)}>
                    <div className="bg-[#111827] rounded-2xl p-6 max-w-sm w-full border border-white/10 shadow-2xl relative animate-fade-in" onClick={(e) => e.stopPropagation()}>
                        <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-2xl bg-white/10 text-red-500 text-3xl mb-6 shadow-inner">
                            <i className="fas fa-triangle-exclamation animate-pulse"></i>
                        </div>
                        <h3 className="text-xl font-black text-slate-100 mb-2">¿Desactivar tu Cuenta?</h3>
                        <p className="text-sm text-slate-400 mb-6 leading-relaxed">
                            Al hacer esto, se suspenderán temporalmente tus accesos a servicios. Podrás reactivarla en cualquier momento comunicándote con el equipo de soporte.
                        </p>
            ...
            {showSuccessModal && (
                <div className="fixed inset-0 z-[200] bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 font-montserrat" onClick={() => setShowSuccessModal(false)}>
                    <div className="bg-[#111827] rounded-2xl p-6 max-w-sm w-full border border-white/10 shadow-2xl relative animate-fade-in" onClick={(e) => e.stopPropagation()}>
                        ...
                        <h3 className="text-xl font-black text-slate-100 mb-2">Configuración Guardada</h3>
                        <p className="text-sm text-slate-400 mb-6 leading-relaxed">
                            {successMessage}
                        </p>
                        <button 
