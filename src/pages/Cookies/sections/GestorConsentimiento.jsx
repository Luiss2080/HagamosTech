                ...
                <div className="container mx-auto px-6 max-w-7xl relative z-20">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 items-stretch">
                        ...
                        <div className="lg:col-span-5">
                            <div className="bg-[#111827] rounded-[2rem] ring-1 ring-orange-100 shadow-xl shadow-orange-950/5 relative overflow-hidden h-full flex flex-col">
                                ...
                                <div className="relative z-10 p-6 flex flex-col flex-1">
                                    {/* Escudo de estado */}
                                    <div className="flex flex-col items-center text-center mb-5 pb-4 border-b border-dashed border-white/10">
                                        ...
                                        <p className="text-[10px] text-slate-400 font-semibold mt-1">{aceptadas} de {total} cookies activas</p>
                                    </div>
                                    ...
                                    <div className="mb-4">
                                        <div className="h-3.5 rounded-full bg-white/10 overflow-hidden border border-orange-50">
                                    ...
                                    {/* Estado actual */}
                                    <div className="flex items-center gap-2.5 p-3 rounded-xl bg-[#FFFFFF] border border-white/10 mb-4">
                                        <div className="w-9 h-9 rounded-lg bg-[#111827] border border-white/10 text-[#A3E635] flex items-center justify-center shrink-0">
                                    ...
                                    <div className="mt-auto pt-4 border-t border-dashed border-white/10 grid grid-cols-2 gap-2.5">
                        ...
                        <div className="lg:col-span-7">
                            <div className="bg-[#111827] rounded-[2rem] ring-1 ring-orange-100 shadow-xl shadow-orange-950/5 relative overflow-hidden h-full">
                                ...
                                <div className="relative z-10 p-5 sm:p-6">
                                    ...
                                    <div className="grid grid-cols-1 gap-2.5">
                                        {TIPOS_COOKIES.map((c) => (
                                            <div key={c.id} className={`flex items-center gap-4 p-4 rounded-2xl border transition-all duration-300 ${estados[c.id] ? 'bg-[#FFFDF9] border-white/10 shadow-sm' : 'bg-[#111827] border-orange-50'}`}>
                                                ...
                                                <div className="flex-1">
                                                    ...
                                                    <p className="text-[11px] text-slate-300 font-semibold mt-0.5">{c.desc}</p>
                                                </div>
                                                <button
                                                    onClick={() => toggle(c.id)}
                                                ...
                                                >
                                                    <span className={`absolute top-1 w-6 h-6 rounded-full bg-[#111827] shadow-md transition-all duration-300 ${estados[c.id] ? 'left-7' : 'left-1'}`}></span>
                                                </button>
                                            </div>
                                        ))}
                                    </div>
