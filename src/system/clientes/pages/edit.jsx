    ...
    <div className="space-y-5 font-montserrat w-full">
      <div className="bg-white dark:bg-[#040408] dark:border-white/8 rounded-2xl p-6 shadow-xl dark:shadow-black/60 border border-slate-200/60 dark:border-white/5 border-l-4 border-l-[#E95A0C] flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          <div className="w-12 h-12 rounded-2xl bg-amber-50 dark:bg-amber-950/40 text-[#E95A0C]mber-600 flex items-center justify-center text-xl font-black shadow-sm shrink-0 border border-amber-200">
            <i className={isColegio ? "fas fa-school" : "fas fa-pen"}></i>
          </div>
          <div>
            ...
            <h2 className="text-xl font-black text-[#4A2E1B] dark:text-white uppercase tracking-wider m-0 leading-none">
              {isColegio ? 'Editar Colegio:' : 'Editar Cliente:'} {clienteForm.nombre}
            </h2>
            <p className="text-xs text-slate-500 dark:text-slate-400 font-bold uppercase tracking-wider mt-1 m-0">
              {isColegio ? 'Modifique los datos comerciales o fiscales registrados del colegio.' : 'Modifique los datos comerciales o fiscales registrados del cliente.'}
            </p>
          </div>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block text-[10px] font-black uppercase tracking-wider text-[#E95A0C] mb-1.5">
                  {clienteForm.tipoCliente === 'JURIDICO' ? 'NIT / REGISTRO FISCAL:' : 'DOCUMENTO DE IDENTIDAD:'} <b className="text-red-500">*</b>
                </label>
        ...
        <div className="bg-white dark:bg-[#040408] dark:border-white/8 rounded-2xl p-6 shadow-xl dark:shadow-black/60 border border-slate-200/60 dark:border-white/5 border-l-4 border-l-[#E95A0C]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="md:col-span-3">
              <label className="block text-[10px] font-black uppercase tracking-wider text-[#E95A0C] mb-1.5">
                {clienteForm.tipoCliente === 'JURIDICO' ? 'RAZON SOCIAL / NOMBRE INSTITUCION:' : 'NOMBRE COMPLETO:'} <b className="text-red-500">*</b>
              </label>
              <input type="text" required value={clienteForm.nombre}
            ...
            <div>
              ...
              <input type="email" required value={clienteForm.correo}
            ...
            <div>
              ...
              <input type="text" required value={clienteForm.telefono}
        ...
        <div className="bg-white dark:bg-[#040408] dark:border-white/8 rounded-2xl p-6 shadow-xl dark:shadow-black/60 border border-slate-200/60 dark:border-white/5 border-l-4 border-l-[#E95A0C]">
          ...
          <div className="space-y-4">
            <div>
              ...
              <input type="text" required value={clienteForm.direccion}
            ...
            <div>
              ...
              <textarea rows="3" value={clienteForm.observaciones || ''}
          ...
          <div className="flex items-center justify-between pt-4 border-t border-slate-100 mt-4">
            <div className="flex items-center gap-2 text-[10px] text-slate-400 font-bold uppercase tracking-wider">
              <i className="fas fa-shield-halved text-[#E95A0C]mber-500 text-xs"></i>
...
export default ClienteEditView;
