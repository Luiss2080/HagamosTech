        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <div className="flex items-center gap-2 text-[10px] font-black uppercase text-slate-400 tracking-widest mb-1">
              ...
              <span>Colegios</span>
              <span>{'>'}</span>
              <span className="text-[#E95A0C]">Registrar Colegio</span>
            </div>
            ...
            <p className="text-xs text-slate-500 dark:text-slate-400 font-bold uppercase tracking-wider mt-1 m-0">
              Ingrese los datos generales para crear la ficha comercial del colegio o convenio de capacitación.
            </p>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-[#040408] dark:border-white/8 rounded-2xl p-6 shadow-xl dark:shadow-black/60 border border-slate-200/60 dark:border-white/5 border-l-4 border-l-[#E95A0C]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-1 md:col-span-2">
              <label className="block text-[10px] font-black uppercase tracking-wider text-[#E95A0C]">NOMBRE DEL COLEGIO / RAZÓN SOCIAL <b className="text-red-500">*</b></label>
            ...
            <div className="space-y-1">
              <label className="block text-[10px] font-black uppercase tracking-wider text-[#E95A0C]">ESTADO <b className="text-red-550">*</b></label>
...
export default ColegioCreateView;
