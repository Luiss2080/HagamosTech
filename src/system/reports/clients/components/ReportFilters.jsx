...
const ReportFilters = ({
  ...
  const tipoOptions = [
    { value: 'todas', label: 'Todos los Clientes', icon: 'fas fa-border-all' },
  ...
  return (
    <div className="bg-white dark:bg-[#040408] dark:border-white/8 rounded-2xl p-5 shadow-xl dark:shadow-black/60 border border-slate-200/60 dark:border-white/5 border-l-4 border-l-[#E95A0C] relative z-25 mb-5">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-12 gap-4 items-end">
        ...
        <div className="sm:col-span-3">
          <DropdownSelect label="Filtro de Clientes" value={tipoVenta} onChange={setTipoVenta} options={tipoOptions} />
        </div>
        <div className="sm:col-span-3">
