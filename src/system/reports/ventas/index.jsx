...
const ReportesVentasAnalitica = ({ setActiveTab }) => {
  ...
  const generarReporte = async () => {
    ...
    try {
      const { data } = await apiClient.get(`/reportes-sistema/ventas?rango=${rango}`);
      if (data.success) {
        setKpis(data.kpis);
  ...
  return (
    <div className="space-y-5 font-montserrat w-full">
      <BreadcrumbHeader
        ...
        subtitle="Generador de reportes interactivos, gráficas y métricas de desempeño comercial."
...
export default ReportesVentasAnalitica;
