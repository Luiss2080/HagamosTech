        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <div className="flex items-center gap-2 text-[10px] font-black uppercase text-slate-400 tracking-widest mb-1">
              ...
              <span>Usuarios</span>
              <span>{'>'}</span>
              <span className="text-[#E95A0C]">Nuevo Usuario</span>
            </div>
            ...
            <p className="text-xs text-slate-500 dark:text-slate-400 font-bold uppercase tracking-wider mt-1 m-0">
              Cree un nuevo perfil de acceso al sistema con credenciales de inicio de sesión personalizadas.
            </p>
          </div>
        </div>
      ...
      <form onSubmit={submitUsuario} className="space-y-5">
        ...
        <div className="bg-white dark:bg-[#040408] dark:border-white/8 rounded-2xl p-6 shadow-xl dark:shadow-black/60 border border-slate-200/60 dark:border-white/5 border-l-4 border-l-[#E95A0C]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-1">
              <label className="block text-[10px] font-black uppercase tracking-wider text-[#E95A0C]">CONTRASEÑA DE ACCESO <b className="text-red-500">*</b></label>
              <div className="relative">
                <i className="fas fa-lock absolute left-3.5 top-1/2 -translate-y-1/2 text-slate-400 text-xs"></i>
                <input type="password" placeholder="Mínimo 6 caracteres" required value={usuarioForm.contrasena}
              ...
              <div className="space-y-1">
                ...
                <div className="relative">
                  ...
                  <input type="text" placeholder="Ej. 69258622" value={usuarioForm.numtel}
                    ...
                    className="w-full pl-9 pr-3.5 py-2.5 rounded-xl border border-slate-200/60 dark:border-white/5 bg-slate-50 dark:bg-[#070710] text-slate-855 text-xs focus:ring-2 focus:ring-[#E95A0C]/40 outline-none font-bold" />
                </div>
              </div>
...
export default UsuarioCreateView;
