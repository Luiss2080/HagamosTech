...
const PROJECTS = [
  {
    num: '01',
    category: 'ECOMMERCE',
    firstPart: 'Integración ERP',
    highlightPart: 'y E-commerce',
    desc: 'Sincronización en tiempo real de inventario, precios y pedidos entre tu sistema contable interno y la plataforma de ventas online.',
    tags: ['Node.js', 'Python', 'MySQL', 'AWS'],
  ...
  },
  {
    num: '02',
    category: 'PAYMENTS',
    firstPart: 'Pasarela de Pagos',
    highlightPart: 'Múltiple',
    desc: 'Implementación de cobros automáticos integrando Stripe, PayPal, pagos locales (QR) y conciliación bancaria directa.',
    tags: ['Stripe', 'Next.js', 'Node.js', 'Docker'],
    icon: 'fa-credit-card',
    images: [
  ...
  },
  {
    num: '03',
    category: 'WHATSAPP',
    firstPart: 'Bot WhatsApp',
    highlightPart: 'Business Avanzado',
    desc: 'Automatización de atención al cliente y ventas por WhatsApp, integrado con tu CRM para guardar historial de chats y crear leads.',
  ...
  },
  {
    num: '04',
    category: 'CRM',
    firstPart: 'Sincronización CRM',
    highlightPart: 'a la Nube',
    desc: 'Conexión bidireccional entre sistemas legados (locales) y CRMs en la nube modernos como HubSpot o Salesforce mediante APIs seguras.',
    tags: ['TypeScript', 'AWS', 'Docker', 'Git'],
...
export default RecorridoIntegraciones;
