import RecorridoSistemas from '../components/RecorridoSistemas';
...
const CLIENTES = ['Rintisa', 'La Calera', 'Hierro Shougang', 'Tai Loy', 'Levapan', 'BSF Almacenes'];
...
const PROCESO = [
  { title: 'Relevamiento de Módulos', desc: 'Identificamos las necesidades críticas en inventario, facturación, compras y reportes financieros.' },
  { title: 'Modelado de Base de Datos', desc: 'Diseñamos la arquitectura de base de datos relacional para garantizar consistencia en transacciones.' },
  { title: 'Integración Facturación', desc: 'Conectamos la facturación computarizada en línea homologada con el SIN (Servicio de Impuestos Nacionales).' },
  { title: 'Migración de Datos', desc: 'Migramos y consolidamos los datos históricos desde planillas Excel e implantamos el sistema ERP.' }
];
...
const VALUE_POINTS = [
  { icon: 'fa-server', label: 'ERP a Medida modular' },
  { icon: 'fa-file-invoice-dollar', label: 'Facturación SIN Homologada' },
  { icon: 'fa-warehouse', label: 'Control Multi-almacén' },
  { icon: 'fa-chart-pie', label: 'Módulo de Finanzas' }
];
    ...
    <div className="relative overflow-hidden min-h-screen bg-white dark:bg-[#0a0a0a] font-montserrat">
      ...
      <section className="relative overflow-hidden pt-20 pb-12" id="home">
        <div className="container mx-auto px-6 max-w-7xl relative z-10 flex flex-col items-center">
          ...
          <Breadcrumb
            paths={[{ label: 'Soluciones' }, { label: 'Desarrollo de Sistemas' }]}
            badgeText="Desarrollo de Sistemas — TECH HOME"
          ...
          <div className="flex flex-col xl:flex-row items-center xl:items-stretch gap-4 xl:-gap-8 justify-between w-full">
            ...
            <div className="w-full xl:w-[35%] flex flex-col gap-5 text-center items-center xl:justify-center animate-slide-down">
              ...
              <h1 className="text-3xl sm:text-4xl lg:text-4xl xl:text-4xl font-black text-[#111827] dark:text-white leading-[1.1] tracking-tight uppercase">
                <span className="block">Desarrollo de</span>
              ...
              <p className="text-base sm:text-lg font-bold text-[#5c6f8f] dark:text-slate-300 leading-relaxed max-w-xl text-center">
                Software empresarial personalizado para automatizar procesos y centralizar la gestión de tu operación en una única plataforma.
              </p>
              ...
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-[#a41e22] to-[#7f1d1d] text-white border border-[#c5a059]/40 shadow-md">
                ...
                <span className="text-[9px] font-black uppercase tracking-wider">Licencia anual, Suscripción mensual o Pago único</span>
              </div>
            </div>
            ...
            <div className="w-full xl:w-[52%] relative min-h-[280px] sm:min-h-[360px] md:min-h-[400px] lg:min-h-[440px] xl:min-h-[480px] flex items-center justify-center -mb-4 sm:mb-0">
              ...
              <div className="relative z-10 w-full max-w-[420px] sm:max-w-[540px] md:max-w-[620px] lg:max-w-[680px] xl:max-w-[740px] 2xl:max-w-[820px] ml-auto animate-fade-in-up delay-200 group/hero flex items-center justify-center mt-6 sm:mt-8">
                ...
                >
                  <img
                    src="/img/07_Servicios/soluciones/DesarrolloSistemas.png"
                    alt="Sistemas ERP"
                    loading="eager"
                    fetchPriority="high"
                    decoding="async"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-6 text-center flex flex-col items-center justify-center">
              ...
              <div className="space-y-5 text-[#5c6f8f] dark:text-slate-355 font-bold leading-relaxed text-sm sm:text-base max-w-2xl text-justify">
                <p>
                  Conectamos todos los departamentos de tu organización en una única plataforma para automatizar procesos, evitar duplicidades y tomar decisiones con métricas reales consolidadas.
                </p>
                <p>
                  <span className="font-black uppercase tracking-widest text-[#a41e22] dark:text-red-400">Incluye: </span>
                  ERP, Inventario, POS, Facturación, Contabilidad, Recursos Humanos, CRM, Gestión Documental, Sistemas Médicos, Logística, Transporte, Financieros, Producción, Académicos y Soluciones Personalizadas.
                </p>
              </div>
            </div>
              ...
              <div className="bg-[#1e1e1e] rounded-3xl shadow-2xl border border-neutral-800 overflow-hidden text-left relative group">
                ...
                <div className="bg-[#252526] p-3 flex items-center justify-between border-b border-neutral-900">
                  <div className="flex items-center gap-1.5">
                    ...
                    <span className="text-[10px] text-slate-400 font-bold ml-2 font-mono">StockManager.js</span>
                  </div>
                ...
                <div className="p-5 font-mono text-[10.5px] sm:text-[11.5px] leading-relaxed text-slate-300 overflow-x-auto select-none space-y-1">
                  <div>const InventoryController = &#123;</div>
                  <div className="pl-4">checkStock: async (productId) =&gt; &#123;</div>
                  <div className="pl-8">const product = await db.products.find(productId);</div>
                  <div className="pl-8">if (product.stock &lt; 5) &#123;</div>
                  <div className="pl-12">await AlertSystem.triggerReorder(productId);</div>
                  <div className="pl-8">&#125;</div>
                  <div className="pl-8">return product.stock;</div>
        ...
        <div className="w-full max-w-[1200px] xl:max-w-[1400px] mx-auto px-4 relative z-10 flex flex-col items-center">
          ...
          <div className="text-center mb-6 max-w-4xl mx-auto">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-[#111827] dark:text-white leading-[1.1] mb-6">
              ¿Cómo gestionas tu empresa hoy <br className="hidden md:block" />
            ...
            <p className="text-base sm:text-lg text-gray-500 dark:text-slate-400 font-medium leading-relaxed max-w-2xl mx-auto mb-6">
              Compara el trabajo administrativo y operativo tradicional fragmentado frente a la automatización con un sistema ERP modular de TECH HOME.
            </p>
            ...
            <div className="flex justify-center">
              <div className="inline-flex p-2 bg-white dark:bg-[#0a0a0a] rounded-full shadow-[0_8px_30px_rgba(0,0,0,0.08)] border border-gray-100 dark:border-[#a41e22]/20 relative z-50 ring-4 ring-gray-50 dark:ring-black/10 scale-[0.85] sm:scale-90 md:scale-100 origin-center mx-auto">
                ...
                >
                  <i className="fa-solid fa-triangle-exclamation"></i> Sin ERP Centralizado
                </button>
                <button
                ...
                >
                  <i className="fa-solid fa-circle-check"></i> Con ERP Centralizado
                </button>
              </div>
            </div>
          </div>
              ...
              <div className={`bg-white dark:bg-[#0a0a0a] rounded-[2.25rem] sm:rounded-[2.5rem] w-full h-full md:min-h-[560px] lg:min-h-[600px] relative overflow-hidden flex flex-col border border-red-50 dark:border-[#a41e22]/10 shadow-[0_20px_60px_-15px_rgba(239,68,68,0.15)] transition-all duration-500 pb-3 sm:pb-4 md:pb-5
                  ...
                  <div className="relative z-10 flex flex-col gap-3">
                    ...
                    <div className="flex items-center justify-center gap-3">
                      <h3 className="text-xl sm:text-2xl font-black text-gray-800 dark:text-white leading-none">
                        Operación con Hojas Excel
                      </h3>
                    </div>
                    <p className="text-center text-[11px] sm:text-sm text-red-500/80 font-semibold max-w-xl mx-auto">
                      Información dispersa en diferentes computadoras, errores de facturación y quiebres de stock.
                    </p>
                  </div>
                </div>
                ...
                <div className="p-2 sm:p-3 md:p-4 relative flex-1 flex flex-col rounded-[2rem] sm:rounded-[2.25rem] overflow-hidden">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 relative z-10 w-full h-full content-start">
                    {[
                      { title: "Archivos Excel Dispersos", icon: "fa-file-excel", desc: "Datos desactualizados y duplicados" },
                      { title: "Quiebres de Stock", icon: "fa-warehouse", desc: "No saber stock real en depósitos" },
                      { title: "Facturación Manual", icon: "fa-keyboard", desc: "Lenta y propensa a errores tributarios" },
                      { title: "Reportes Tardíos", icon: "fa-clock", desc: "Métricas contables listas en semanas" },
                      { title: "Sin Auditoría de Cambios", icon: "fa-user-slash", desc: "Imposible saber quién modificó datos" },
                      { title: "Decisiones Intuitivas", icon: "fa-brain", desc: "Sin gráficos financieros fiables" }
                    ].map((item, i) => (
                      <div
                        key={i}
            ...
            >
              <div className={`bg-gradient-to-br from-[#a41e22] to-[#7f1d1d] w-full h-full md:min-h-[560px] lg:min-h-[600px] relative overflow-hidden flex flex-col rounded-[2.25rem] sm:rounded-[2.5rem] shadow-2xl border border-white/20 transition-all duration-500 pb-3 sm:pb-4 md:pb-5
                ...
                <div className="bg-white/5 backdrop-blur-md px-3 py-4 sm:px-4 sm:py-5 md:px-5 md:py-6 border-b border-white/10 relative z-20 overflow-hidden">
                  <div className="relative z-10 flex flex-col gap-3">
                    ...
                    <p className="text-center text-[11px] sm:text-sm text-blue-50/90 font-semibold max-w-xl mx-auto">
                      Base de datos central relacional, facturación computarizada SIN y reportes consolidados.
                    </p>
                  </div>
                </div>
                ...
                <div className="p-2 sm:p-3 md:p-4 relative flex-1 flex flex-col rounded-[2rem] sm:rounded-[2.25rem] overflow-hidden">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 relative z-10 w-full h-full content-start">
                    {[
                      { title: "Base de Datos Única", icon: "fa-database", desc: "Datos conectados y en la nube" },
                      { title: "Control de Stock Real", icon: "fa-warehouse", desc: "Alertas automáticas de reabastecimiento" },
                      { title: "Facturación en Línea", icon: "fa-file-invoice-dollar", desc: "Sincronizada con Impuestos Nacionales" },
                      { title: "Métricas Contables al Instante", icon: "fa-chart-line", desc: "Balances y estados listos en un click" },
                      { title: "Auditoría de Actividad", icon: "fa-user-check", desc: "Historial completo de acciones" },
                      { title: "Decisiones Informadas", icon: "fa-chart-pie", desc: "Tableros de control con gráficos" }
                    ].map((item, i) => (
                      <div
                        key={i}
